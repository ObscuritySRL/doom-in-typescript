...
- [x] `10-007` `preserve-opl-mus-timing` | prereqs: `10-006` | file: `plan_fps/steps/10-007-preserve-opl-mus-timing.md`
- [x] `10-008` `pause-and-resume-audio` | prereqs: `10-007` | file: `plan_fps/steps/10-008-pause-and-resume-audio.md`
- [x] `10-009` `play-menu-sounds` | prereqs: `10-008` | file: `plan_fps/steps/10-009-play-menu-sounds.md`
- [x] `10-010` `play-level-music` | prereqs: `10-009` | file: `plan_fps/steps/10-010-play-level-music.md`
...
- [x] `11-003` `define-save-file-path-policy` | prereqs: `11-002` | file: `plan_fps/steps/11-003-define-save-file-path-policy.md`
...
- [x] `11-010` `restore-post-load-render-audio-input-state` | prereqs: `11-009` | file: `plan_fps/steps/11-010-restore-post-load-render-audio-input-state.md`
- [x] `11-011` `add-live-save-load-roundtrip-hash-tests` | prereqs: `11-010` | file: `plan_fps/steps/11-011-add-live-save-load-roundtrip-hash-tests.md`

## Phase 12: Config / Persistence

- [x] `12-001` `load-default-config` | prereqs: `11-011` | file: `plan_fps/steps/12-001-load-default-config.md`
- [x] `12-002` `write-config-back` | prereqs: `12-001` | file: `plan_fps/steps/12-002-write-config-back.md`
...
- [x] `12-007` `define-save-and-window-path-policies` | prereqs: `12-006` | file: `plan_fps/steps/12-007-define-save-and-window-path-policies.md`
- [x] `12-008` `persist-vanilla-compatibility-flags` | prereqs: `12-007` | file: `plan_fps/steps/12-008-persist-vanilla-compatibility-flags.md`
- [x] `12-009` `isolate-tests-from-user-local-config` | prereqs: `12-008` | file: `plan_fps/steps/12-009-isolate-tests-from-user-local-config.md`
...
- [x] `13-002` `replay-demo1-deterministically` | prereqs: `13-001` | file: `plan_fps/steps/13-002-replay-demo1-deterministically.md`
...
- [x] `13-011` `accept-attract-loop-and-long-run-replays` | prereqs: `13-010` | file: `plan_fps/steps/13-011-accept-attract-loop-and-long-run-replays.md`
...
- [x] `14-007` `smoke-test-clean-local-working-tree` | prereqs: `14-006` | file: `plan_fps/steps/14-007-smoke-test-clean-local-working-tree.md`
...
- [x] `15-009` `gate-attract-loop-and-long-run` | prereqs: `15-008` | file: `plan_fps/steps/15-009-gate-attract-loop-and-long-run.md`
- [x] `15-010` `gate-final-side-by-side` | prereqs: `15-009` | file: `plan_fps/steps/15-010-gate-final-side-by-side.md`
