...
- [ ] `00-005` `pin-bun-runtime-and-package-manager` | prereqs: `00-004` | file: `plan_fps/steps/00-005-pin-bun-runtime-and-package-manager.md`
- [ ] `00-006` `record-bun-native-api-preference` | prereqs: `00-005` | file: `plan_fps/steps/00-006-record-bun-native-api-preference.md`
...
- [ ] `00-014` `test-plan-validation-script` | prereqs: `00-013` | file: `plan_fps/steps/00-014-test-plan-validation-script.md`
...
- [ ] `01-005` `audit-pure-engine-surface` | prereqs: `01-004` | file: `plan_fps/steps/01-005-audit-pure-engine-surface.md`
...
- [ ] `02-001` `capture-implementation-clean-launch-expectations` | prereqs: `01-015` | file: `plan_fps/steps/02-001-capture-implementation-clean-launch-expectations.md`
- [ ] `02-002` `capture-reference-clean-launch` | prereqs: `02-001` | file: `plan_fps/steps/02-002-capture-reference-clean-launch.md`
- [ ] `02-003` `capture-startup-sequence` | prereqs: `02-002` | file: `plan_fps/steps/02-003-capture-startup-sequence.md`
- [ ] `02-004` `capture-initial-title-frame` | prereqs: `02-003` | file: `plan_fps/steps/02-004-capture-initial-title-frame.md`
...
- [ ] `02-009` `capture-demo3-playback-checkpoints` | prereqs: `02-008` | file: `plan_fps/steps/02-009-capture-demo3-playback-checkpoints.md`
- [ ] `02-010` `capture-menu-open-close-behavior` | prereqs: `02-009` | file: `plan_fps/steps/02-010-capture-menu-open-close-behavior.md`
- [ ] `02-011` `capture-new-game-menu-path` | prereqs: `02-010` | file: `plan_fps/steps/02-011-capture-new-game-menu-path.md`
...
- [ ] `02-019` `capture-e1m1-start-from-clean-launch` | prereqs: `02-018` | file: `plan_fps/steps/02-019-capture-e1m1-start-from-clean-launch.md`
...
- [ ] `03-001` `add-root-doom-ts-command-contract` | prereqs: `02-031` | file: `plan_fps/steps/03-001-add-root-doom-ts-command-contract.md`
...
- [ ] `04-001` `create-bun-compatible-win32-window` | prereqs: `03-015` | file: `plan_fps/steps/04-001-create-bun-compatible-win32-window.md`
...
- [ ] `04-011` `blit-framebuffer-to-window` | prereqs: `04-010` | file: `plan_fps/steps/04-011-blit-framebuffer-to-window.md`
...
- [ ] `07-005` `implement-new-game-menu` | prereqs: `07-004` | file: `plan_fps/steps/07-005-implement-new-game-menu.md`
...
- [ ] `07-014` `implement-read-this-help-pages` | prereqs: `07-013` | file: `plan_fps/steps/07-014-implement-read-this-help-pages.md`
...
- [ ] `07-019` `preserve-menu-timing-idle-behavior` | prereqs: `07-018` | file: `plan_fps/steps/07-019-preserve-menu-timing-idle-behavior.md`
...
- [ ] `08-005` `wire-world-thinker-ticking` | prereqs: `08-004` | file: `plan_fps/steps/08-005-wire-world-thinker-ticking.md`
...
- [ ] `08-011` `wire-death-reborn-flow` | prereqs: `08-010` | file: `plan_fps/steps/08-011-wire-death-reborn-flow.md`
...
- [ ] `09-001` `render-full-frame-every-visible-tic` | prereqs: `08-014` | file: `plan_fps/steps/09-001-render-full-frame-every-visible-tic.md`
