# [ ] STEP 07-008: quit-and-cleanup-flow

## Goal

Implement quit and cleanup flow so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\bootstrap\quitFlow.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\bootstrap\quit-flow.test.ts

## Verification

- `bun test test/bootstrap/quit-flow.test.ts`
- `bun test`
...
- The targeted test file `test/bootstrap/quit-flow.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
