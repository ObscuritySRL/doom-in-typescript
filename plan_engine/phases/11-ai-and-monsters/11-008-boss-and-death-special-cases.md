# [ ] STEP 11-008: boss-and-death-special-cases

## Goal

Implement boss and death special cases so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\ai\bossSpecials.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\ai\boss-specials.test.ts

## Verification

- `bun test test/ai/boss-specials.test.ts`
- `bun test`
...
- The targeted test file `test/ai/boss-specials.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
