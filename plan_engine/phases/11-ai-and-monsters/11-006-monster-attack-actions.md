# [ ] STEP 11-006: monster-attack-actions

## Goal

Implement monster attack actions so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\ai\attacks.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\ai\monster-attacks.test.ts

## Verification

- `bun test test/ai/monster-attacks.test.ts`
- `bun test`
...
- The targeted test file `test/ai/monster-attacks.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
