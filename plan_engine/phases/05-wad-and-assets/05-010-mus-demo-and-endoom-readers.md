# [ ] STEP 05-010: mus-demo-and-endoom-readers

## Goal

Implement mus demo and endoom readers so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\plans\manifests\wad-directory-summary.json
- d:\Projects\bun-win32\doom\universal-doom\DOOM1.WAD
- https://github.com/chocolate-doom/chocolate-doom/blob/master/src/doom/r_data.c
...
- d:\Projects\bun-win32\doom_codex\src\assets\mus.ts
- d:\Projects\bun-win32\doom_codex\src\demo\demoFile.ts
- d:\Projects\bun-win32\doom_codex\src\ui\endoom.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\wad\misc-assets.test.ts

## Verification

- `bun test test/wad/misc-assets.test.ts`
- `bun test`
...
- The targeted test file `test/wad/misc-assets.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
