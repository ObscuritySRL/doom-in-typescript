# [ ] STEP 05-008: patch-and-sprite-catalog

## Goal

Implement patch and sprite catalog so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\assets\patchCatalog.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\wad\patches-sprites.test.ts

## Verification

- `bun test test/wad/patches-sprites.test.ts`
- `bun test`
...
- The targeted test file `test/wad/patches-sprites.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
