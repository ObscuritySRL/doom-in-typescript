# [ ] STEP 03-003: add-golden-file-loader

## Goal

Implement add golden file loader so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\test_harness\golden.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test_harness\golden-loader.test.ts

## Verification

- `bun test test/_harness/golden-loader.test.ts`
- `bun test`
...
- The targeted test file `test/_harness/golden-loader.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
