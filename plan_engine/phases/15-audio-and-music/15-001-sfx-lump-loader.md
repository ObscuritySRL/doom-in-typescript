# [ ] STEP 15-001: sfx-lump-loader

## Goal

Implement sfx lump loader so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\audio\sfxLumps.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\audio\sfx-loader.test.ts

## Verification

- `bun test test/audio/sfx-loader.test.ts`
- `bun test`
...
- The targeted test file `test/audio/sfx-loader.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
