# [ ] STEP 15-003: attenuation-and-stereo-separation

## Goal

Implement attenuation and stereo separation so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\audio\spatial.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\audio\attenuation.test.ts

## Verification

- `bun test test/audio/attenuation.test.ts`
- `bun test`
...
- The targeted test file `test/audio/attenuation.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
