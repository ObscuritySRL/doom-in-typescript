# [x] STEP 12-001: animated-textures-and-flats

## Goal

Implement animated textures and flats so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\specials\animations.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\specials\animations.test.ts

## Verification

- `bun test test/specials/animations.test.ts`
- `bun test`
...
- The targeted test file `test/specials/animations.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
