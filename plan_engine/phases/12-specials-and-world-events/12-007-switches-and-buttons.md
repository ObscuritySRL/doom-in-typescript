# [ ] STEP 12-007: switches-and-buttons

## Goal

Implement switches and buttons so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\specials\switches.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\specials\switches.test.ts

## Verification

- `bun test test/specials/switches.test.ts`
- `bun test`
...
- The targeted test file `test/specials/switches.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
