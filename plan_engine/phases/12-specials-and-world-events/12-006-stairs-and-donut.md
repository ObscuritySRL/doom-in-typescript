# [ ] STEP 12-006: stairs-and-donut

## Goal

Implement stairs and donut so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\specials\stairsDonut.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\specials\stairs-donut.test.ts

## Verification

- `bun test test/specials/stairs-donut.test.ts`
- `bun test`
...
- The targeted test file `test/specials/stairs-donut.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
