# [ ] STEP 12-005: ceiling-movers-and-crushers

## Goal

Implement ceiling movers and crushers so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\specials\ceilings.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\specials\ceilings.test.ts

## Verification

- `bun test test/specials/ceilings.test.ts`
- `bun test`
...
- The targeted test file `test/specials/ceilings.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
