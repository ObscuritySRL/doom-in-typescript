# [ ] STEP 16-007: player-mobj-sector-serialization

## Goal

Implement player mobj sector serialization so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\save\coreSerialization.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\save\core-serialization.test.ts

## Verification

- `bun test test/save/core-serialization.test.ts`
- `bun test`
...
- The targeted test file `test/save/core-serialization.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
