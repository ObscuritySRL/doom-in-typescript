# [ ] STEP 16-005: demo-playback

## Goal

Implement demo playback so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\demo\demoPlayback.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\demo\demo-playback.test.ts

## Verification

- `bun test test/demo/demo-playback.test.ts`
- `bun test`
...
- The targeted test file `test/demo/demo-playback.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
