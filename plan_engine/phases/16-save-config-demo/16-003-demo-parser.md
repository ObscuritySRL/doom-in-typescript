# [ ] STEP 16-003: demo-parser

## Goal

Implement demo parser so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\demo\demoParse.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\demo\demo-parse.test.ts

## Verification

- `bun test test/demo/demo-parse.test.ts`
- `bun test`
...
- The targeted test file `test/demo/demo-parse.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
