# [ ] STEP 16-004: demo-recorder

## Goal

Implement demo recorder so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\demo\demoRecord.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\demo\demo-record.test.ts

## Verification

- `bun test test/demo/demo-record.test.ts`
- `bun test`
...
- The targeted test file `test/demo/demo-record.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
