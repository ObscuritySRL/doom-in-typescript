# [ ] STEP 14-007: finale-text-and-screens

## Goal

Implement finale text and screens so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\ui\finale.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\ui\finale.test.ts

## Verification

- `bun test test/ui/finale.test.ts`
- `bun test`
...
- The targeted test file `test/ui/finale.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
