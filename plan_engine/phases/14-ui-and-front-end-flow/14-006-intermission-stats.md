# [ ] STEP 14-006: intermission-stats

## Goal

Implement intermission stats so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\ui\intermission.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\ui\intermission.test.ts

## Verification

- `bun test test/ui/intermission.test.ts`
- `bun test`
...
- The targeted test file `test/ui/intermission.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
