# [x] STEP 14-005: menu-tree-and-repeat-timing

## Goal

Implement menu tree and repeat timing so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\ui\menus.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\ui\menus.test.ts

## Verification

- `bun test test/ui/menus.test.ts`
- `bun test`
...
- The targeted test file `test/ui/menus.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
