# [ ] STEP 14-008: title-credit-help-demo-sequencing

## Goal

Implement title credit help demo sequencing so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\ui\frontEndSequence.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\ui\front-end-sequence.test.ts

## Verification

- `bun test test/ui/front-end-sequence.test.ts`
- `bun test`
...
- The targeted test file `test/ui/front-end-sequence.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
