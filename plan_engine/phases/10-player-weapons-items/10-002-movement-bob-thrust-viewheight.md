# [x] STEP 10-002: movement-bob-thrust-viewheight

## Goal

Implement movement bob thrust viewheight so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\player\movement.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\player\movement-bob.test.ts

## Verification

- `bun test test/player/movement-bob.test.ts`
- `bun test`
...
- The targeted test file `test/player/movement-bob.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
