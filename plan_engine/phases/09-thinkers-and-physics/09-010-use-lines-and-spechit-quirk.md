# [x] STEP 09-010: use-lines-and-spechit-quirk

## Goal

Implement use lines and spechit quirk so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\world\useLines.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\world\use-lines.test.ts

## Verification

- `bun test test/world/use-lines.test.ts`
- `bun test`
...
- The targeted test file `test/world/use-lines.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
