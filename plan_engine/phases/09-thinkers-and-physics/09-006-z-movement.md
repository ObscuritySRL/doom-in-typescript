# [ ] STEP 09-006: z-movement

## Goal

Implement z movement so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\world\zMovement.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\world\z-movement.test.ts

## Verification

- `bun test test/world/z-movement.test.ts`
- `bun test`
...
- The targeted test file `test/world/z-movement.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
