# [x] STEP 09-009: radius-attack-and-damage-spread

## Goal

Implement radius attack and damage spread so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\world\radiusAttack.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\world\radius-attack.test.ts

## Verification

- `bun test test/world/radius-attack.test.ts`
- `bun test`
...
- The targeted test file `test/world/radius-attack.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
