# [ ] STEP 09-011: teleport-and-mapthing-special-cases

## Goal

Implement teleport and mapthing special cases so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\world\teleport.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\world\teleport-spawn.test.ts

## Verification

- `bun test test/world/teleport-spawn.test.ts`
- `bun test`
...
- The targeted test file `test/world/teleport-spawn.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
