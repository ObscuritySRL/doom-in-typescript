# [ ] STEP 17-005: menu-and-ui-timing-suite

## Goal

Implement menu and ui timing suite so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\test\parity\fixtures\menuTiming.json

## Test Files

- d:\Projects\bun-win32\doom_codex\test\parity\menu-timing.test.ts

## Verification

- `bun test test/parity/menu-timing.test.ts`
- `bun test`
...
- The targeted test file `test/parity/menu-timing.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
