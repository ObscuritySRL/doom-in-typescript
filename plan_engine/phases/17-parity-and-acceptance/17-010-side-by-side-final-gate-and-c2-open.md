# [ ] STEP 17-010: side-by-side-final-gate-and-c2-open

## Goal

Implement side by side final gate and c2 open so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\reference\manifests\c1-complete.json

## Test Files

- d:\Projects\bun-win32\doom_codex\test\parity\final-gate.test.ts

## Verification

- `bun test test/parity/final-gate.test.ts`
- `bun test`
...
- The targeted test file `test/parity/final-gate.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
