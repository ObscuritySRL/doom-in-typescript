# [ ] STEP 17-003: scripted-input-core-mechanics

## Goal

Implement scripted input core mechanics so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\test\parity\fixtures\scriptedMechanics.json

## Test Files

- d:\Projects\bun-win32\doom_codex\test\parity\scripted-mechanics.test.ts

## Verification

- `bun test test/parity/scripted-mechanics.test.ts`
- `bun test`
...
- The targeted test file `test/parity/scripted-mechanics.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
