# [ ] STEP 04-005: angle-type-and-wrap

## Goal

Implement angle type and wrap so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\core\angle.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\core\angle.wrap.test.ts

## Verification

- `bun test test/core/angle.wrap.test.ts`
- `bun test`
...
- The targeted test file `test/core/angle.wrap.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
