# [ ] STEP 08-001: things-loader

## Goal

Implement things loader so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\map\things.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\map\things-loader.test.ts

## Verification

- `bun test test/map/things-loader.test.ts`
- `bun test`
...
- The targeted test file `test/map/things-loader.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
