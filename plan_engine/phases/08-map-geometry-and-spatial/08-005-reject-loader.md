# [ ] STEP 08-005: reject-loader

## Goal

Implement reject loader so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\map\reject.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\map\reject-loader.test.ts

## Verification

- `bun test test/map/reject-loader.test.ts`
- `bun test`
...
- The targeted test file `test/map/reject-loader.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
