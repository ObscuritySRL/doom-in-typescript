# [ ] STEP 08-004: blockmap-loader

## Goal

Implement blockmap loader so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\map\blockmap.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\map\blockmap-loader.test.ts

## Verification

- `bun test test/map/blockmap-loader.test.ts`
- `bun test`
...
- The targeted test file `test/map/blockmap-loader.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
