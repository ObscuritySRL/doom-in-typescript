# [ ] STEP 13-009: visplane-span-render

## Goal

Implement visplane span render so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\render\visplaneSpans.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\render\visplane-span-render.test.ts

## Verification

- `bun test test/render/visplane-span-render.test.ts`
- `bun test`
...
- The targeted test file `test/render/visplane-span-render.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
