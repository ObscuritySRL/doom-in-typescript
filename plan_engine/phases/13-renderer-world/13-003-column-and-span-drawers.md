# [ ] STEP 13-003: column-and-span-drawers

## Goal

Implement column and span drawers so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\render\drawPrimitives.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\render\column-span-draw.test.ts

## Verification

- `bun test test/render/column-span-draw.test.ts`
- `bun test`
...
- The targeted test file `test/render/column-span-draw.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
