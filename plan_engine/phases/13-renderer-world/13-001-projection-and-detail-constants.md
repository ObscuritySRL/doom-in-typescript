# [ ] STEP 13-001: projection-and-detail-constants

## Goal

Implement projection and detail constants so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\render\projection.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\render\projection-constants.test.ts

## Verification

- `bun test test/render/projection-constants.test.ts`
- `bun test`
...
- The targeted test file `test/render/projection-constants.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
