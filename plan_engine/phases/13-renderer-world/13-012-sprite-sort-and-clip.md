# [ ] STEP 13-012: sprite-sort-and-clip

## Goal

Implement sprite sort and clip so it matches the canonical reference behavior and is locked by the listed test coverage.
...
- d:\Projects\bun-win32\doom_codex\src\render\spriteClip.ts

## Test Files

- d:\Projects\bun-win32\doom_codex\test\render\sprite-sort-clip.test.ts

## Verification

- `bun test test/render/sprite-sort-clip.test.ts`
- `bun test`
...
- The targeted test file `test/render/sprite-sort-clip.test.ts` covers the normal path and at least one parity-sensitive edge case, and every listed verification command passes.
