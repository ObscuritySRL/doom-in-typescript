# [ ] STEP 04-008: Implement Deterministic Reset Seed
...
Deliver the smallest verified increment for implement deterministic reset seed while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/core/implement-deterministic-reset-seed.ts
- test/vanilla_parity/core/implement-deterministic-reset-seed.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/implement-deterministic-reset-seed.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-008 with test/vanilla_parity/core/implement-deterministic-reset-seed.test.ts proving the new behavior or audit result.
