# [ ] STEP 07-023: Implement Plasma Rifle Actions
...
Implement Plasma Rifle Actions

## goal

Deliver the smallest verified increment for implement plasma rifle actions while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-plasma-rifle-actions.ts
- test/vanilla_parity/player/implement-plasma-rifle-actions.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-plasma-rifle-actions.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-023 with test/vanilla_parity/player/implement-plasma-rifle-actions.test.ts proving the new behavior or audit result.
