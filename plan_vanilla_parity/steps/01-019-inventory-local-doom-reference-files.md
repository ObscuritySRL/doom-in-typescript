# [ ] STEP 01-019: Inventory Local Doom Reference Files
...
Inventory Local Doom Reference Files

## goal

Deliver the smallest verified increment for inventory local doom reference files while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-local-doom-reference-files.json
- test/vanilla_parity/current-state/inventory-local-doom-reference-files.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-local-doom-reference-files.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-019 with test/vanilla_parity/current-state/inventory-local-doom-reference-files.test.ts proving the new behavior or audit result.
