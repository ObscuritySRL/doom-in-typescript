# [ ] STEP 05-017: Detect Registered Iwad Capabilities
...
Detect Registered Iwad Capabilities

## goal

Deliver the smallest verified increment for detect registered iwad capabilities while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/detect-registered-iwad-capabilities.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/detect-registered-iwad-capabilities.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-017 with test/vanilla_parity/wad/detect-registered-iwad-capabilities.test.ts proving the new behavior or audit result.
