# [ ] STEP 03-007: Implement Doom Game Mode Detection
...
Implement Doom Game Mode Detection

## goal

Deliver the smallest verified increment for implement doom game mode detection while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/bootstrap/implement-doom-game-mode-detection.ts
- test/vanilla_parity/launch/implement-doom-game-mode-detection.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-doom-game-mode-detection.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-007 with test/vanilla_parity/launch/implement-doom-game-mode-detection.test.ts proving the new behavior or audit result.
