# [ ] STEP 02-009: Define Deterministic Input Stream Format
...
Define Deterministic Input Stream Format

## goal

Deliver the smallest verified increment for define deterministic input stream format while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/define-deterministic-input-stream-format.json
- test/vanilla_parity/oracles/define-deterministic-input-stream-format.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/define-deterministic-input-stream-format.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-009 with test/vanilla_parity/oracles/define-deterministic-input-stream-format.test.ts proving the new behavior or audit result.
