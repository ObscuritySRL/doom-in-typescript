# [ ] STEP 09-009: Implement Draw Span Low And High Detail
...
Implement Draw Span Low And High Detail

## goal

Deliver the smallest verified increment for implement draw span low and high detail while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/implement-draw-span-low-and-high-detail.ts
- test/vanilla_parity/render/implement-draw-span-low-and-high-detail.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-draw-span-low-and-high-detail.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-009 with test/vanilla_parity/render/implement-draw-span-low-and-high-detail.test.ts proving the new behavior or audit result.
