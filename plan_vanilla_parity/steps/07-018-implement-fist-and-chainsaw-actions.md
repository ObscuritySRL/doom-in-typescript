# [ ] STEP 07-018: Implement Fist And Chainsaw Actions
...
Implement Fist And Chainsaw Actions

## goal

Deliver the smallest verified increment for implement fist and chainsaw actions while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-fist-and-chainsaw-actions.ts
- test/vanilla_parity/player/implement-fist-and-chainsaw-actions.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-fist-and-chainsaw-actions.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-018 with test/vanilla_parity/player/implement-fist-and-chainsaw-actions.test.ts proving the new behavior or audit result.
