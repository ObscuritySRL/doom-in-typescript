...
Deliver the smallest verified increment for persist screen settings while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/config/persist-screen-settings.ts
- test/vanilla_parity/save/persist-screen-settings.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/persist-screen-settings.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-006 with test/vanilla_parity/save/persist-screen-settings.test.ts proving the new behavior or audit result.
