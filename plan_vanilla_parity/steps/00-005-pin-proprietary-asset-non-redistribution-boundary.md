# [ ] STEP 00-005: Pin Proprietary Asset Non Redistribution Boundary
...
Deliver the smallest verified increment for pin proprietary asset non redistribution boundary while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/plan_vanilla_parity/pin-proprietary-asset-non-redistribution-boundary.test.ts
...
- `bun run format`
- `bun test test/plan_vanilla_parity/pin-proprietary-asset-non-redistribution-boundary.test.ts`
- `bun test`
...
- A committed and pushed change set for 00-005 with test/plan_vanilla_parity/pin-proprietary-asset-non-redistribution-boundary.test.ts proving the new behavior or audit result.
