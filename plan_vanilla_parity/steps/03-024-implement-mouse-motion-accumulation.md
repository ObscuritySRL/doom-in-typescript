# [ ] STEP 03-024: Implement Mouse Motion Accumulation
...
Implement Mouse Motion Accumulation

## goal

Deliver the smallest verified increment for implement mouse motion accumulation while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-mouse-motion-accumulation.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-024 with test/vanilla_parity/launch/implement-mouse-motion-accumulation.test.ts proving the new behavior or audit result.
