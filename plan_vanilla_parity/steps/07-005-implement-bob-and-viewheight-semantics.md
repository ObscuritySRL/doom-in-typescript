# [ ] STEP 07-005: Implement Bob And Viewheight Semantics
...
Implement Bob And Viewheight Semantics

## goal

Deliver the smallest verified increment for implement bob and viewheight semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-bob-and-viewheight-semantics.ts
- test/vanilla_parity/player/implement-bob-and-viewheight-semantics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-bob-and-viewheight-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-005 with test/vanilla_parity/player/implement-bob-and-viewheight-semantics.test.ts proving the new behavior or audit result.
