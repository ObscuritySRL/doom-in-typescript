# [ ] STEP 10-017: Implement Menu Sound Events
...
Implement Menu Sound Events

## goal

Deliver the smallest verified increment for implement menu sound events while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-menu-sound-events.ts
- test/vanilla_parity/ui/implement-menu-sound-events.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-menu-sound-events.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-017 with test/vanilla_parity/ui/implement-menu-sound-events.test.ts proving the new behavior or audit result.
