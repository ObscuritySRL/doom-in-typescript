# [ ] STEP 05-003: Verify Duplicate Lump Precedence
...
Verify Duplicate Lump Precedence

## goal

Deliver the smallest verified increment for verify duplicate lump precedence while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/verify-duplicate-lump-precedence.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/verify-duplicate-lump-precedence.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-003 with test/vanilla_parity/wad/verify-duplicate-lump-precedence.test.ts proving the new behavior or audit result.
