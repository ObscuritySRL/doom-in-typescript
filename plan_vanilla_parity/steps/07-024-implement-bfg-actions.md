# [ ] STEP 07-024: Implement Bfg Actions
...
Implement Bfg Actions

## goal

Deliver the smallest verified increment for implement bfg actions while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-bfg-actions.ts
- test/vanilla_parity/player/implement-bfg-actions.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-bfg-actions.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-024 with test/vanilla_parity/player/implement-bfg-actions.test.ts proving the new behavior or audit result.
