# [ ] STEP 08-010: Implement Imp Attacks
...
Implement Imp Attacks

## goal

Deliver the smallest verified increment for implement imp attacks while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-imp-attacks.ts
- test/vanilla_parity/ai/implement-imp-attacks.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-imp-attacks.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-010 with test/vanilla_parity/ai/implement-imp-attacks.test.ts proving the new behavior or audit result.
