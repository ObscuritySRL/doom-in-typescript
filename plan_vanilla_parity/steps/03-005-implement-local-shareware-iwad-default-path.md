# [ ] STEP 03-005: Implement Local Shareware Iwad Default Path
...
Implement Local Shareware Iwad Default Path

## goal

Deliver the smallest verified increment for implement local shareware iwad default path while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/bootstrap/implement-local-shareware-iwad-default-path.ts
- test/vanilla_parity/launch/implement-local-shareware-iwad-default-path.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-local-shareware-iwad-default-path.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-005 with test/vanilla_parity/launch/implement-local-shareware-iwad-default-path.test.ts proving the new behavior or audit result.
