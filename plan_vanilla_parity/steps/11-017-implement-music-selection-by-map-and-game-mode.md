# [ ] STEP 11-017: Implement Music Selection By Map And Game Mode
...
Implement Music Selection By Map And Game Mode

## goal

Deliver the smallest verified increment for implement music selection by map and game mode while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-music-selection-by-map-and-game-mode.ts
- test/vanilla_parity/audio/implement-music-selection-by-map-and-game-mode.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-music-selection-by-map-and-game-mode.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-017 with test/vanilla_parity/audio/implement-music-selection-by-map-and-game-mode.test.ts proving the new behavior or audit result.
