# [ ] STEP 00-013: Define Oracle Capture Policy
...
Deliver the smallest verified increment for define oracle capture policy while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/plan_vanilla_parity/define-oracle-capture-policy.test.ts
...
- `bun run format`
- `bun test test/plan_vanilla_parity/define-oracle-capture-policy.test.ts`
- `bun test`
...
- A committed and pushed change set for 00-013 with test/plan_vanilla_parity/define-oracle-capture-policy.test.ts proving the new behavior or audit result.
