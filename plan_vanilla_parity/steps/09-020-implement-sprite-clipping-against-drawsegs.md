# [ ] STEP 09-020: Implement Sprite Clipping Against Drawsegs
...
Implement Sprite Clipping Against Drawsegs

## goal

Deliver the smallest verified increment for implement sprite clipping against drawsegs while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/implement-sprite-clipping-against-drawsegs.ts
- test/vanilla_parity/render/implement-sprite-clipping-against-drawsegs.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-sprite-clipping-against-drawsegs.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-020 with test/vanilla_parity/render/implement-sprite-clipping-against-drawsegs.test.ts proving the new behavior or audit result.
