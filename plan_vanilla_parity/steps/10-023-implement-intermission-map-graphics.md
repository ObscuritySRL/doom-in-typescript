# [ ] STEP 10-023: Implement Intermission Map Graphics
...
Implement Intermission Map Graphics

## goal

Deliver the smallest verified increment for implement intermission map graphics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-intermission-map-graphics.ts
- test/vanilla_parity/ui/implement-intermission-map-graphics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-intermission-map-graphics.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-023 with test/vanilla_parity/ui/implement-intermission-map-graphics.test.ts proving the new behavior or audit result.
