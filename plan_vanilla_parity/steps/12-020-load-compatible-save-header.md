# [ ] STEP 12-020: Load Compatible Save Header
...
Load Compatible Save Header

## goal

Deliver the smallest verified increment for load compatible save header while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/save/load-compatible-save-header.ts
- test/vanilla_parity/save/load-compatible-save-header.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/load-compatible-save-header.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-020 with test/vanilla_parity/save/load-compatible-save-header.test.ts proving the new behavior or audit result.
