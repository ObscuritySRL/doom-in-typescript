# [ ] STEP 09-029: Implement Status Bar Key And Ammo Widgets
...
Implement Status Bar Key And Ammo Widgets

## goal

Deliver the smallest verified increment for implement status bar key and ammo widgets while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-status-bar-key-and-ammo-widgets.ts
- test/vanilla_parity/render/implement-status-bar-key-and-ammo-widgets.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-status-bar-key-and-ammo-widgets.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-029 with test/vanilla_parity/render/implement-status-bar-key-and-ammo-widgets.test.ts proving the new behavior or audit result.
