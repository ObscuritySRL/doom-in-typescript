# [ ] STEP 04-014: Implement Main Loop Preloop Ordering
...
Implement Main Loop Preloop Ordering

## goal

Deliver the smallest verified increment for implement main loop preloop ordering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/core/implement-main-loop-preloop-ordering.ts
- test/vanilla_parity/core/implement-main-loop-preloop-ordering.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/implement-main-loop-preloop-ordering.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-014 with test/vanilla_parity/core/implement-main-loop-preloop-ordering.test.ts proving the new behavior or audit result.
