# [ ] STEP 11-011: Implement Menu Sound Routing
...
Implement Menu Sound Routing

## goal

Deliver the smallest verified increment for implement menu sound routing while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-menu-sound-routing.ts
- test/vanilla_parity/audio/implement-menu-sound-routing.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-menu-sound-routing.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-011 with test/vanilla_parity/audio/implement-menu-sound-routing.test.ts proving the new behavior or audit result.
