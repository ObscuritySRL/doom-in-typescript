# [ ] STEP 07-013: Implement Keycard And Skull Key Pickups
...
Implement Keycard And Skull Key Pickups

## goal

Deliver the smallest verified increment for implement keycard and skull key pickups while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-keycard-and-skull-key-pickups.ts
- test/vanilla_parity/player/implement-keycard-and-skull-key-pickups.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-keycard-and-skull-key-pickups.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-013 with test/vanilla_parity/player/implement-keycard-and-skull-key-pickups.test.ts proving the new behavior or audit result.
