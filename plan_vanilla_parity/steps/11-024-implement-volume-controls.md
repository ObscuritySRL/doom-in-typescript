# [ ] STEP 11-024: Implement Volume Controls
...
Deliver the smallest verified increment for implement volume controls while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-volume-controls.ts
- test/vanilla_parity/audio/implement-volume-controls.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-volume-controls.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-024 with test/vanilla_parity/audio/implement-volume-controls.test.ts proving the new behavior or audit result.
