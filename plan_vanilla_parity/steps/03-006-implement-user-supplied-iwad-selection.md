# [ ] STEP 03-006: Implement User Supplied Iwad Selection
...
Implement User Supplied Iwad Selection

## goal

Deliver the smallest verified increment for implement user supplied iwad selection while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/bootstrap/implement-user-supplied-iwad-selection.ts
- test/vanilla_parity/launch/implement-user-supplied-iwad-selection.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-user-supplied-iwad-selection.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-006 with test/vanilla_parity/launch/implement-user-supplied-iwad-selection.test.ts proving the new behavior or audit result.
