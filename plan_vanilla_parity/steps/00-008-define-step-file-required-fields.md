# [ ] STEP 00-008: Define Step File Required Fields
...
Deliver the smallest verified increment for define step file required fields while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/plan_vanilla_parity/define-step-file-required-fields.test.ts
...
- `bun run format`
- `bun test test/plan_vanilla_parity/define-step-file-required-fields.test.ts`
- `bun test`
...
- A committed and pushed change set for 00-008 with test/plan_vanilla_parity/define-step-file-required-fields.test.ts proving the new behavior or audit result.
