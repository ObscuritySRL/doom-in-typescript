# [ ] STEP 06-001: Parse Vertex Linedef Sidedef Sector Lumps
...
Parse Vertex Linedef Sidedef Sector Lumps

## goal

Deliver the smallest verified increment for parse vertex linedef sidedef sector lumps while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/parse-vertex-linedef-sidedef-sector-lumps.ts
- test/vanilla_parity/map/parse-vertex-linedef-sidedef-sector-lumps.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/parse-vertex-linedef-sidedef-sector-lumps.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-001 with test/vanilla_parity/map/parse-vertex-linedef-sidedef-sector-lumps.test.ts proving the new behavior or audit result.
