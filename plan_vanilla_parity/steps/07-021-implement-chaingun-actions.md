# [ ] STEP 07-021: Implement Chaingun Actions
...
Implement Chaingun Actions

## goal

Deliver the smallest verified increment for implement chaingun actions while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-chaingun-actions.ts
- test/vanilla_parity/player/implement-chaingun-actions.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-chaingun-actions.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-021 with test/vanilla_parity/player/implement-chaingun-actions.test.ts proving the new behavior or audit result.
