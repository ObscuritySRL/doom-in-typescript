# [ ] STEP 04-026: Compare Demo Three Ticcmd Stream
...
Compare Demo Three Ticcmd Stream

## goal

Deliver the smallest verified increment for compare demo three ticcmd stream while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/core/compare-demo-three-ticcmd-stream.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-026 with test/vanilla_parity/core/compare-demo-three-ticcmd-stream.test.ts proving the new behavior or audit result.
