# [ ] STEP 07-010: Implement Health And Armor Pickups
...
Implement Health And Armor Pickups

## goal

Deliver the smallest verified increment for implement health and armor pickups while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-health-and-armor-pickups.ts
- test/vanilla_parity/player/implement-health-and-armor-pickups.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-health-and-armor-pickups.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-010 with test/vanilla_parity/player/implement-health-and-armor-pickups.test.ts proving the new behavior or audit result.
