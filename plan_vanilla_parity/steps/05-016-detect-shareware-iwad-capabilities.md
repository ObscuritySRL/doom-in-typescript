# [ ] STEP 05-016: Detect Shareware Iwad Capabilities
...
Detect Shareware Iwad Capabilities

## goal

Deliver the smallest verified increment for detect shareware iwad capabilities while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/detect-shareware-iwad-capabilities.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/detect-shareware-iwad-capabilities.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-016 with test/vanilla_parity/wad/detect-shareware-iwad-capabilities.test.ts proving the new behavior or audit result.
