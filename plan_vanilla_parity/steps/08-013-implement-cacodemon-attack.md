# [ ] STEP 08-013: Implement Cacodemon Attack
...
Implement Cacodemon Attack

## goal

Deliver the smallest verified increment for implement cacodemon attack while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-cacodemon-attack.ts
- test/vanilla_parity/ai/implement-cacodemon-attack.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-cacodemon-attack.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-013 with test/vanilla_parity/ai/implement-cacodemon-attack.test.ts proving the new behavior or audit result.
