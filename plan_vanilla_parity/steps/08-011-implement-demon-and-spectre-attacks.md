# [ ] STEP 08-011: Implement Demon And Spectre Attacks
...
Implement Demon And Spectre Attacks

## goal

Deliver the smallest verified increment for implement demon and spectre attacks while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-demon-and-spectre-attacks.ts
- test/vanilla_parity/ai/implement-demon-and-spectre-attacks.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-demon-and-spectre-attacks.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-011 with test/vanilla_parity/ai/implement-demon-and-spectre-attacks.test.ts proving the new behavior or audit result.
