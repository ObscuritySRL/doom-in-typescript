# [ ] STEP 09-001: Implement View Setup Constants
...
Implement View Setup Constants

## goal

Deliver the smallest verified increment for implement view setup constants while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/render/implement-view-setup-constants.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-view-setup-constants.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-001 with test/vanilla_parity/render/implement-view-setup-constants.test.ts proving the new behavior or audit result.
