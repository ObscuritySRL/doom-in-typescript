# [ ] STEP 07-001: Implement Player Reborn State
...
Implement Player Reborn State

## goal

Deliver the smallest verified increment for implement player reborn state while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-player-reborn-state.ts
- test/vanilla_parity/player/implement-player-reborn-state.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-player-reborn-state.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-001 with test/vanilla_parity/player/implement-player-reborn-state.test.ts proving the new behavior or audit result.
