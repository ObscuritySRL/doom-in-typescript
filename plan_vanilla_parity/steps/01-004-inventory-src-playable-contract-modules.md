# [ ] STEP 01-004: Inventory Src Playable Contract Modules
...
Inventory Src Playable Contract Modules

## goal

Deliver the smallest verified increment for inventory src playable contract modules while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-src-playable-contract-modules.json
- test/vanilla_parity/current-state/inventory-src-playable-contract-modules.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-src-playable-contract-modules.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-004 with test/vanilla_parity/current-state/inventory-src-playable-contract-modules.test.ts proving the new behavior or audit result.
