# [ ] STEP 07-027: Implement Autoaim Semantics
...
Implement Autoaim Semantics

## goal

Deliver the smallest verified increment for implement autoaim semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-autoaim-semantics.ts
- test/vanilla_parity/player/implement-autoaim-semantics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-autoaim-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-027 with test/vanilla_parity/player/implement-autoaim-semantics.test.ts proving the new behavior or audit result.
