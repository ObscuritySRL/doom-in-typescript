# [ ] STEP 08-004: Implement Look For Players
...
Implement Look For Players

## goal

Deliver the smallest verified increment for implement look for players while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-look-for-players.ts
- test/vanilla_parity/ai/implement-look-for-players.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-look-for-players.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-004 with test/vanilla_parity/ai/implement-look-for-players.test.ts proving the new behavior or audit result.
