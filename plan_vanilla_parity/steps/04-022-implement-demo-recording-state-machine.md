# [ ] STEP 04-022: Implement Demo Recording State Machine
...
Implement Demo Recording State Machine

## goal

Deliver the smallest verified increment for implement demo recording state machine while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/demo/implement-demo-recording-state-machine.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/implement-demo-recording-state-machine.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-022 with test/vanilla_parity/core/implement-demo-recording-state-machine.test.ts proving the new behavior or audit result.
