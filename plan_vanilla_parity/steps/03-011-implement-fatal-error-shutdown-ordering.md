# [ ] STEP 03-011: Implement Fatal Error Shutdown Ordering
...
Implement Fatal Error Shutdown Ordering

## goal

Deliver the smallest verified increment for implement fatal error shutdown ordering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/bootstrap/implement-fatal-error-shutdown-ordering.ts
- test/vanilla_parity/launch/implement-fatal-error-shutdown-ordering.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-fatal-error-shutdown-ordering.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-011 with test/vanilla_parity/launch/implement-fatal-error-shutdown-ordering.test.ts proving the new behavior or audit result.
