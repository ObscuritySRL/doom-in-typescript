# [ ] STEP 13-001: Gate Shareware Doom One Full Playthrough
...
Deliver the smallest verified increment for gate shareware doom one full playthrough while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/acceptance/gate-shareware-doom-one-full-playthrough.json
- test/vanilla_parity/acceptance/gate-shareware-doom-one-full-playthrough.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/acceptance/gate-shareware-doom-one-full-playthrough.test.ts`
- `bun test`
...
- A committed and pushed change set for 13-001 with test/vanilla_parity/acceptance/gate-shareware-doom-one-full-playthrough.test.ts proving the new behavior or audit result.
