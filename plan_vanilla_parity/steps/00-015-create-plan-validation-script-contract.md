# [ ] STEP 00-015: Create Plan Validation Script Contract
...
Deliver the smallest verified increment for create plan validation script contract while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/plan_vanilla_parity/create-plan-validation-script-contract.test.ts
...
- `bun run format`
- `bun test test/plan_vanilla_parity/create-plan-validation-script-contract.test.ts`
- `bun test`
...
- A committed and pushed change set for 00-015 with test/plan_vanilla_parity/create-plan-validation-script-contract.test.ts proving the new behavior or audit result.
