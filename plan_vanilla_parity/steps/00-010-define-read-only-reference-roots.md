# [ ] STEP 00-010: Define Read Only Reference Roots
...
Deliver the smallest verified increment for define read only reference roots while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/plan_vanilla_parity/define-read-only-reference-roots.test.ts
...
- `bun run format`
- `bun test test/plan_vanilla_parity/define-read-only-reference-roots.test.ts`
- `bun test`
...
- A committed and pushed change set for 00-010 with test/plan_vanilla_parity/define-read-only-reference-roots.test.ts proving the new behavior or audit result.
