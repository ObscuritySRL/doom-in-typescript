# [ ] STEP 05-004: Verify Marker Range Semantics
...
Verify Marker Range Semantics

## goal

Deliver the smallest verified increment for verify marker range semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/verify-marker-range-semantics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/verify-marker-range-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-004 with test/vanilla_parity/wad/verify-marker-range-semantics.test.ts proving the new behavior or audit result.
