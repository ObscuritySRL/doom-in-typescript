# [ ] STEP 07-006: Implement Player Thrust And Friction
...
Implement Player Thrust And Friction

## goal

Deliver the smallest verified increment for implement player thrust and friction while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-player-thrust-and-friction.ts
- test/vanilla_parity/player/implement-player-thrust-and-friction.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-player-thrust-and-friction.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-006 with test/vanilla_parity/player/implement-player-thrust-and-friction.test.ts proving the new behavior or audit result.
