# [ ] STEP 07-025: Implement Projectile Spawn And Explosion
...
Implement Projectile Spawn And Explosion

## goal

Deliver the smallest verified increment for implement projectile spawn and explosion while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-projectile-spawn-and-explosion.ts
- test/vanilla_parity/player/implement-projectile-spawn-and-explosion.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-projectile-spawn-and-explosion.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-025 with test/vanilla_parity/player/implement-projectile-spawn-and-explosion.test.ts proving the new behavior or audit result.
