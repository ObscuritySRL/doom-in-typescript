# [ ] STEP 09-010: Implement Visplane Allocation And Merge
...
Implement Visplane Allocation And Merge

## goal

Deliver the smallest verified increment for implement visplane allocation and merge while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/implement-visplane-allocation-and-merge.ts
- test/vanilla_parity/render/implement-visplane-allocation-and-merge.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-visplane-allocation-and-merge.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-010 with test/vanilla_parity/render/implement-visplane-allocation-and-merge.test.ts proving the new behavior or audit result.
