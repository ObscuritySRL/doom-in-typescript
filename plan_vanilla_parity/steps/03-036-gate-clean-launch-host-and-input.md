# [ ] STEP 03-036: Gate Clean Launch Host And Input
...
Gate Clean Launch Host And Input

## goal

Deliver the smallest verified increment for gate clean launch host and input while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/bootstrap/gate-clean-launch-host-and-input.ts
- test/vanilla_parity/launch/gate-clean-launch-host-and-input.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/gate-clean-launch-host-and-input.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-036 with test/vanilla_parity/launch/gate-clean-launch-host-and-input.test.ts proving the new behavior or audit result.
