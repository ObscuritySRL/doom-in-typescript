# [ ] STEP 05-012: Parse Sound Effect Lumps
...
Parse Sound Effect Lumps

## goal

Deliver the smallest verified increment for parse sound effect lumps while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/parse-sound-effect-lumps.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/parse-sound-effect-lumps.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-012 with test/vanilla_parity/wad/parse-sound-effect-lumps.test.ts proving the new behavior or audit result.
