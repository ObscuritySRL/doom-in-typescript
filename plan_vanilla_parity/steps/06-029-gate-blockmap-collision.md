# [ ] STEP 06-029: Gate Blockmap Collision
...
Gate Blockmap Collision

## goal

Deliver the smallest verified increment for gate blockmap collision while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/world/gate-blockmap-collision.ts
- test/vanilla_parity/map/gate-blockmap-collision.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/gate-blockmap-collision.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-029 with test/vanilla_parity/map/gate-blockmap-collision.test.ts proving the new behavior or audit result.
