# [ ] STEP 11-021: Implement OPL Synthesis Core
...
Implement OPL Synthesis Core

## goal

Deliver the smallest verified increment for implement opl synthesis core while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-opl-synthesis-core.ts
- test/vanilla_parity/audio/implement-opl-synthesis-core.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-opl-synthesis-core.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-021 with test/vanilla_parity/audio/implement-opl-synthesis-core.test.ts proving the new behavior or audit result.
