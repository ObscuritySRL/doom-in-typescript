# [ ] STEP 01-009: Inventory AI And Specials Modules
...
Inventory AI And Specials Modules

## goal

Deliver the smallest verified increment for inventory ai and specials modules while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-ai-and-specials-modules.json
- test/vanilla_parity/current-state/inventory-ai-and-specials-modules.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-ai-and-specials-modules.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-009 with test/vanilla_parity/current-state/inventory-ai-and-specials-modules.test.ts proving the new behavior or audit result.
