# [ ] STEP 09-027: Implement Status Bar Numbers And Percent Widgets
...
Implement Status Bar Numbers And Percent Widgets

## goal

Deliver the smallest verified increment for implement status bar numbers and percent widgets while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-status-bar-numbers-and-percent-widgets.ts
- test/vanilla_parity/render/implement-status-bar-numbers-and-percent-widgets.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-status-bar-numbers-and-percent-widgets.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-027 with test/vanilla_parity/render/implement-status-bar-numbers-and-percent-widgets.test.ts proving the new behavior or audit result.
