# [ ] STEP 04-029: Gate Core Determinism
...
Gate Core Determinism

## goal

Deliver the smallest verified increment for gate core determinism while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/core/gate-core-determinism.ts
- test/vanilla_parity/core/gate-core-determinism.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/gate-core-determinism.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-029 with test/vanilla_parity/core/gate-core-determinism.test.ts proving the new behavior or audit result.
