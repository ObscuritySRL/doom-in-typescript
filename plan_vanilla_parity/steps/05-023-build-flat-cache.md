...
Deliver the smallest verified increment for build flat cache while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/build-flat-cache.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/build-flat-cache.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-023 with test/vanilla_parity/wad/build-flat-cache.test.ts proving the new behavior or audit result.
