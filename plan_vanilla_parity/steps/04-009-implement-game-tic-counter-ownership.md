# [ ] STEP 04-009: Implement Game Tic Counter Ownership
...
Implement Game Tic Counter Ownership

## goal

Deliver the smallest verified increment for implement game tic counter ownership while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/core/implement-game-tic-counter-ownership.ts
- test/vanilla_parity/core/implement-game-tic-counter-ownership.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/implement-game-tic-counter-ownership.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-009 with test/vanilla_parity/core/implement-game-tic-counter-ownership.test.ts proving the new behavior or audit result.
