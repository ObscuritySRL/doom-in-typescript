# [ ] STEP 11-025: Implement Sound Shutdown Ordering
...
Implement Sound Shutdown Ordering

## goal

Deliver the smallest verified increment for implement sound shutdown ordering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-sound-shutdown-ordering.ts
- test/vanilla_parity/audio/implement-sound-shutdown-ordering.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-sound-shutdown-ordering.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-025 with test/vanilla_parity/audio/implement-sound-shutdown-ordering.test.ts proving the new behavior or audit result.
