# [ ] STEP 11-015: Implement MUS Scheduler
...
Implement MUS Scheduler

## goal

Deliver the smallest verified increment for implement mus scheduler while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-mus-scheduler.ts
- test/vanilla_parity/audio/implement-mus-scheduler.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-mus-scheduler.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-015 with test/vanilla_parity/audio/implement-mus-scheduler.test.ts proving the new behavior or audit result.
