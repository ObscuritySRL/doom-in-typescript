# [ ] STEP 10-004: Implement New Game Menu
...
Deliver the smallest verified increment for implement new game menu while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-new-game-menu.ts
- test/vanilla_parity/ui/implement-new-game-menu.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-new-game-menu.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-004 with test/vanilla_parity/ui/implement-new-game-menu.test.ts proving the new behavior or audit result.
