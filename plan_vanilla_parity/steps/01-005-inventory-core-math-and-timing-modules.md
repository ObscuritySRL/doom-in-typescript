# [ ] STEP 01-005: Inventory Core Math And Timing Modules
...
Inventory Core Math And Timing Modules

## goal

Deliver the smallest verified increment for inventory core math and timing modules while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-core-math-and-timing-modules.json
- test/vanilla_parity/current-state/inventory-core-math-and-timing-modules.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-core-math-and-timing-modules.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-005 with test/vanilla_parity/current-state/inventory-core-math-and-timing-modules.test.ts proving the new behavior or audit result.
