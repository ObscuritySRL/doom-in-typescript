# [ ] STEP 01-020: Inventory Iwad Search And Hash Evidence
...
Inventory Iwad Search And Hash Evidence

## goal

Deliver the smallest verified increment for inventory iwad search and hash evidence while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-iwad-search-and-hash-evidence.json
- test/vanilla_parity/current-state/inventory-iwad-search-and-hash-evidence.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-iwad-search-and-hash-evidence.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-020 with test/vanilla_parity/current-state/inventory-iwad-search-and-hash-evidence.test.ts proving the new behavior or audit result.
