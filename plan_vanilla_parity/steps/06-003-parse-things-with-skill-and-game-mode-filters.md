# [ ] STEP 06-003: Parse Things With Skill And Game Mode Filters
...
Parse Things With Skill And Game Mode Filters

## goal

Deliver the smallest verified increment for parse things with skill and game mode filters while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/parse-things-with-skill-and-game-mode-filters.ts
- test/vanilla_parity/map/parse-things-with-skill-and-game-mode-filters.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/parse-things-with-skill-and-game-mode-filters.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-003 with test/vanilla_parity/map/parse-things-with-skill-and-game-mode-filters.test.ts proving the new behavior or audit result.
