# [ ] STEP 01-014: Inventory Demo And Replay Modules
...
Inventory Demo And Replay Modules

## goal

Deliver the smallest verified increment for inventory demo and replay modules while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-demo-and-replay-modules.json
- test/vanilla_parity/current-state/inventory-demo-and-replay-modules.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-demo-and-replay-modules.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-014 with test/vanilla_parity/current-state/inventory-demo-and-replay-modules.test.ts proving the new behavior or audit result.
