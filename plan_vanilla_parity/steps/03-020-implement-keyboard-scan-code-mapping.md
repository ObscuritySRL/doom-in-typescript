# [ ] STEP 03-020: Implement Keyboard Scan Code Mapping
...
Implement Keyboard Scan Code Mapping

## goal

Deliver the smallest verified increment for implement keyboard scan code mapping while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-keyboard-scan-code-mapping.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-020 with test/vanilla_parity/launch/implement-keyboard-scan-code-mapping.test.ts proving the new behavior or audit result.
