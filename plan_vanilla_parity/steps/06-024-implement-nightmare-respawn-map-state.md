# [ ] STEP 06-024: Implement Nightmare Respawn Map State
...
Implement Nightmare Respawn Map State

## goal

Deliver the smallest verified increment for implement nightmare respawn map state while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-nightmare-respawn-map-state.ts
- test/vanilla_parity/map/implement-nightmare-respawn-map-state.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-nightmare-respawn-map-state.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-024 with test/vanilla_parity/map/implement-nightmare-respawn-map-state.test.ts proving the new behavior or audit result.
