# [ ] STEP 03-018: Implement Message Pump Ordering
...
Implement Message Pump Ordering

## goal

Deliver the smallest verified increment for implement message pump ordering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-message-pump-ordering.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-018 with test/vanilla_parity/launch/implement-message-pump-ordering.test.ts proving the new behavior or audit result.
