# [ ] STEP 09-034: Add Framebuffer Hash Hook
...
Add Framebuffer Hash Hook

## goal

Deliver the smallest verified increment for add framebuffer hash hook while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/add-framebuffer-hash-hook.ts
- test/vanilla_parity/render/add-framebuffer-hash-hook.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/add-framebuffer-hash-hook.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-034 with test/vanilla_parity/render/add-framebuffer-hash-hook.test.ts proving the new behavior or audit result.
