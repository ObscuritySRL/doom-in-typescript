# [ ] STEP 07-019: Implement Pistol Actions
...
Implement Pistol Actions

## goal

Deliver the smallest verified increment for implement pistol actions while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-pistol-actions.ts
- test/vanilla_parity/player/implement-pistol-actions.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-pistol-actions.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-019 with test/vanilla_parity/player/implement-pistol-actions.test.ts proving the new behavior or audit result.
