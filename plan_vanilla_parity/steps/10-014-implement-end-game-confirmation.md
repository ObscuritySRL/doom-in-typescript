# [ ] STEP 10-014: Implement End Game Confirmation
...
Implement End Game Confirmation

## goal

Deliver the smallest verified increment for implement end game confirmation while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-end-game-confirmation.ts
- test/vanilla_parity/ui/implement-end-game-confirmation.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-end-game-confirmation.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-014 with test/vanilla_parity/ui/implement-end-game-confirmation.test.ts proving the new behavior or audit result.
