# [ ] STEP 09-038: Gate Status Bar And Automap Parity
...
Gate Status Bar And Automap Parity

## goal

Deliver the smallest verified increment for gate status bar and automap parity while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/gate-status-bar-and-automap-parity.ts
- test/vanilla_parity/render/gate-status-bar-and-automap-parity.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/gate-status-bar-and-automap-parity.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-038 with test/vanilla_parity/render/gate-status-bar-and-automap-parity.test.ts proving the new behavior or audit result.
