# [ ] STEP 07-012: Implement Weapon Pickups
...
Deliver the smallest verified increment for implement weapon pickups while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-weapon-pickups.ts
- test/vanilla_parity/player/implement-weapon-pickups.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-weapon-pickups.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-012 with test/vanilla_parity/player/implement-weapon-pickups.test.ts proving the new behavior or audit result.
