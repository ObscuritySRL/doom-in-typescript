# [ ] STEP 11-007: Implement Pitch And Volume Semantics
...
Implement Pitch And Volume Semantics

## goal

Deliver the smallest verified increment for implement pitch and volume semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-pitch-and-volume-semantics.ts
- test/vanilla_parity/audio/implement-pitch-and-volume-semantics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-pitch-and-volume-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-007 with test/vanilla_parity/audio/implement-pitch-and-volume-semantics.test.ts proving the new behavior or audit result.
