# [ ] STEP 03-002: Implement Vanilla Command Line Parsing
...
Implement Vanilla Command Line Parsing

## goal

Deliver the smallest verified increment for implement vanilla command line parsing while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/launch/implement-vanilla-command-line-parsing.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-vanilla-command-line-parsing.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-002 with test/vanilla_parity/launch/implement-vanilla-command-line-parsing.test.ts proving the new behavior or audit result.
