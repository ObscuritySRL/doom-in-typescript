# [ ] STEP 11-012: Implement Weapon And Monster Sound Routing
...
Implement Weapon And Monster Sound Routing

## goal

Deliver the smallest verified increment for implement weapon and monster sound routing while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-weapon-and-monster-sound-routing.ts
- test/vanilla_parity/audio/implement-weapon-and-monster-sound-routing.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-weapon-and-monster-sound-routing.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-012 with test/vanilla_parity/audio/implement-weapon-and-monster-sound-routing.test.ts proving the new behavior or audit result.
