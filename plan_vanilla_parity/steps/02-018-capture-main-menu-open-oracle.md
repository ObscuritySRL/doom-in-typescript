# [ ] STEP 02-018: Capture Main Menu Open Oracle
...
Capture Main Menu Open Oracle

## goal

Deliver the smallest verified increment for capture main menu open oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-main-menu-open-oracle.json
- test/vanilla_parity/oracles/capture-main-menu-open-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-main-menu-open-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-018 with test/vanilla_parity/oracles/capture-main-menu-open-oracle.test.ts proving the new behavior or audit result.
