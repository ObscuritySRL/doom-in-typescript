# [ ] STEP 10-001: Implement Title Loop Sequence
...
Implement Title Loop Sequence

## goal

Deliver the smallest verified increment for implement title loop sequence while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-title-loop-sequence.ts
- test/vanilla_parity/ui/implement-title-loop-sequence.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-title-loop-sequence.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-001 with test/vanilla_parity/ui/implement-title-loop-sequence.test.ts proving the new behavior or audit result.
