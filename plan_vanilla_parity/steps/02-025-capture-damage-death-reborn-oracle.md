# [ ] STEP 02-025: Capture Damage Death Reborn Oracle
...
Capture Damage Death Reborn Oracle

## goal

Deliver the smallest verified increment for capture damage death reborn oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-damage-death-reborn-oracle.json
- test/vanilla_parity/oracles/capture-damage-death-reborn-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-damage-death-reborn-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-025 with test/vanilla_parity/oracles/capture-damage-death-reborn-oracle.test.ts proving the new behavior or audit result.
