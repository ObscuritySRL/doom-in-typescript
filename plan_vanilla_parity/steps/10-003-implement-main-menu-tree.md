# [ ] STEP 10-003: Implement Main Menu Tree
...
Implement Main Menu Tree

## goal

Deliver the smallest verified increment for implement main menu tree while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-main-menu-tree.ts
- test/vanilla_parity/ui/implement-main-menu-tree.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-main-menu-tree.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-003 with test/vanilla_parity/ui/implement-main-menu-tree.test.ts proving the new behavior or audit result.
