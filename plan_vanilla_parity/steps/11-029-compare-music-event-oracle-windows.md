# [ ] STEP 11-029: Compare Music Event Oracle Windows
...
Compare Music Event Oracle Windows

## goal

Deliver the smallest verified increment for compare music event oracle windows while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/compare-music-event-oracle-windows.ts
- test/vanilla_parity/audio/compare-music-event-oracle-windows.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/compare-music-event-oracle-windows.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-029 with test/vanilla_parity/audio/compare-music-event-oracle-windows.test.ts proving the new behavior or audit result.
