# [ ] STEP 08-028: Implement Line Trigger Repeat Rules
...
Implement Line Trigger Repeat Rules

## goal

Deliver the smallest verified increment for implement line trigger repeat rules while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/specials/implement-line-trigger-repeat-rules.ts
- test/vanilla_parity/ai/implement-line-trigger-repeat-rules.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-line-trigger-repeat-rules.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-028 with test/vanilla_parity/ai/implement-line-trigger-repeat-rules.test.ts proving the new behavior or audit result.
