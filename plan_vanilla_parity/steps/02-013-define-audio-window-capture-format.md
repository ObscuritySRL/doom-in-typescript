# [ ] STEP 02-013: Define Audio Window Capture Format
...
Define Audio Window Capture Format

## goal

Deliver the smallest verified increment for define audio window capture format while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/define-audio-window-capture-format.json
- test/vanilla_parity/oracles/define-audio-window-capture-format.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/define-audio-window-capture-format.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-013 with test/vanilla_parity/oracles/define-audio-window-capture-format.test.ts proving the new behavior or audit result.
