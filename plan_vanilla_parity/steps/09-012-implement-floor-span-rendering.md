# [ ] STEP 09-012: Implement Floor Span Rendering
...
Implement Floor Span Rendering

## goal

Deliver the smallest verified increment for implement floor span rendering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/implement-floor-span-rendering.ts
- test/vanilla_parity/render/implement-floor-span-rendering.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-floor-span-rendering.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-012 with test/vanilla_parity/render/implement-floor-span-rendering.test.ts proving the new behavior or audit result.
