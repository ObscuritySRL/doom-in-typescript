# [ ] STEP 02-032: Capture Sfx And Music Oracle Windows
...
Capture Sfx And Music Oracle Windows

## goal

Deliver the smallest verified increment for capture sfx and music oracle windows while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-sfx-and-music-oracle-windows.json
- test/vanilla_parity/oracles/capture-sfx-and-music-oracle-windows.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-sfx-and-music-oracle-windows.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-032 with test/vanilla_parity/oracles/capture-sfx-and-music-oracle-windows.test.ts proving the new behavior or audit result.
