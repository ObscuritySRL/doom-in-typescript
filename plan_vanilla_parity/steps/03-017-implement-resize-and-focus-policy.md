# [ ] STEP 03-017: Implement Resize And Focus Policy
...
Implement Resize And Focus Policy

## goal

Deliver the smallest verified increment for implement resize and focus policy while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-resize-and-focus-policy.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-017 with test/vanilla_parity/launch/implement-resize-and-focus-policy.test.ts proving the new behavior or audit result.
