# [ ] STEP 11-028: Compare Sfx Oracle Windows
...
Compare Sfx Oracle Windows

## goal

Deliver the smallest verified increment for compare sfx oracle windows while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/compare-sfx-oracle-windows.ts
- test/vanilla_parity/audio/compare-sfx-oracle-windows.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/compare-sfx-oracle-windows.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-028 with test/vanilla_parity/audio/compare-sfx-oracle-windows.test.ts proving the new behavior or audit result.
