# [ ] STEP 03-013: Apply Window Title And Icon Policy
...
Apply Window Title And Icon Policy

## goal

Deliver the smallest verified increment for apply window title and icon policy while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/bootstrap/apply-window-title-and-icon-policy.ts
- test/vanilla_parity/launch/apply-window-title-and-icon-policy.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/apply-window-title-and-icon-policy.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-013 with test/vanilla_parity/launch/apply-window-title-and-icon-policy.test.ts proving the new behavior or audit result.
