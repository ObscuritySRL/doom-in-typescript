...
Deliver the smallest verified increment for parse default cfg while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/config/parse-default-cfg.ts
- test/vanilla_parity/save/parse-default-cfg.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/parse-default-cfg.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-001 with test/vanilla_parity/save/parse-default-cfg.test.ts proving the new behavior or audit result.
