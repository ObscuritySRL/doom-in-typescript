# [ ] STEP 02-023: Capture Scripted Pickup Oracle
...
Capture Scripted Pickup Oracle

## goal

Deliver the smallest verified increment for capture scripted pickup oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-scripted-pickup-oracle.json
- test/vanilla_parity/oracles/capture-scripted-pickup-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-scripted-pickup-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-023 with test/vanilla_parity/oracles/capture-scripted-pickup-oracle.test.ts proving the new behavior or audit result.
