# [ ] STEP 08-018: Implement Boss Death Specials
...
Implement Boss Death Specials

## goal

Deliver the smallest verified increment for implement boss death specials while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/specials/implement-boss-death-specials.ts
- test/vanilla_parity/ai/implement-boss-death-specials.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-boss-death-specials.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-018 with test/vanilla_parity/ai/implement-boss-death-specials.test.ts proving the new behavior or audit result.
