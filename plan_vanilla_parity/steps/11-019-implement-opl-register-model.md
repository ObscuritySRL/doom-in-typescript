# [ ] STEP 11-019: Implement OPL Register Model
...
Implement OPL Register Model

## goal

Deliver the smallest verified increment for implement opl register model while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-opl-register-model.ts
- test/vanilla_parity/audio/implement-opl-register-model.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-opl-register-model.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-019 with test/vanilla_parity/audio/implement-opl-register-model.test.ts proving the new behavior or audit result.
