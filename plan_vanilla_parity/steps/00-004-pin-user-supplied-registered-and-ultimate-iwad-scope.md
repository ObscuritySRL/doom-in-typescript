# [ ] STEP 00-004: Pin User Supplied Registered And Ultimate Iwad Scope
...
Deliver the smallest verified increment for pin user supplied registered and ultimate iwad scope while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/plan_vanilla_parity/pin-user-supplied-registered-and-ultimate-iwad-scope.test.ts
...
- `bun run format`
- `bun test test/plan_vanilla_parity/pin-user-supplied-registered-and-ultimate-iwad-scope.test.ts`
- `bun test`
...
- A committed and pushed change set for 00-004 with test/plan_vanilla_parity/pin-user-supplied-registered-and-ultimate-iwad-scope.test.ts proving the new behavior or audit result.
