# [ ] STEP 01-003: Inventory Src Bootstrap Surface
...
Inventory Src Bootstrap Surface

## goal

Deliver the smallest verified increment for inventory src bootstrap surface while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-src-bootstrap-surface.json
- test/vanilla_parity/current-state/inventory-src-bootstrap-surface.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-src-bootstrap-surface.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-003 with test/vanilla_parity/current-state/inventory-src-bootstrap-surface.test.ts proving the new behavior or audit result.
