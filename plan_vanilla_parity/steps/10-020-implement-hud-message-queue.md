# [ ] STEP 10-020: Implement HUD Message Queue
...
Implement HUD Message Queue

## goal

Deliver the smallest verified increment for implement hud message queue while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-hud-message-queue.ts
- test/vanilla_parity/ui/implement-hud-message-queue.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-hud-message-queue.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-020 with test/vanilla_parity/ui/implement-hud-message-queue.test.ts proving the new behavior or audit result.
