# [ ] STEP 02-031: Capture Save Load Roundtrip Oracle
...
Capture Save Load Roundtrip Oracle

## goal

Deliver the smallest verified increment for capture save load roundtrip oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-save-load-roundtrip-oracle.json
- test/vanilla_parity/oracles/capture-save-load-roundtrip-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-save-load-roundtrip-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-031 with test/vanilla_parity/oracles/capture-save-load-roundtrip-oracle.test.ts proving the new behavior or audit result.
