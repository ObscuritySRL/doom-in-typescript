# [ ] STEP 05-015: Parse Map Lump Bundle Boundaries
...
Parse Map Lump Bundle Boundaries

## goal

Deliver the smallest verified increment for parse map lump bundle boundaries while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/parse-map-lump-bundle-boundaries.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/parse-map-lump-bundle-boundaries.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-015 with test/vanilla_parity/wad/parse-map-lump-bundle-boundaries.test.ts proving the new behavior or audit result.
