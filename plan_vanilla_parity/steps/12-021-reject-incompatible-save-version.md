# [ ] STEP 12-021: Reject Incompatible Save Version
...
Reject Incompatible Save Version

## goal

Deliver the smallest verified increment for reject incompatible save version while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/save/reject-incompatible-save-version.ts
- test/vanilla_parity/save/reject-incompatible-save-version.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/reject-incompatible-save-version.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-021 with test/vanilla_parity/save/reject-incompatible-save-version.test.ts proving the new behavior or audit result.
