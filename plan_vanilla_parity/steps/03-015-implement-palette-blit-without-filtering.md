# [ ] STEP 03-015: Implement Palette Blit Without Filtering
...
Implement Palette Blit Without Filtering

## goal

Deliver the smallest verified increment for implement palette blit without filtering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/bootstrap/implement-palette-blit-without-filtering.ts
- test/vanilla_parity/launch/implement-palette-blit-without-filtering.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-palette-blit-without-filtering.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-015 with test/vanilla_parity/launch/implement-palette-blit-without-filtering.test.ts proving the new behavior or audit result.
