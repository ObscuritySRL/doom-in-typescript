# [ ] STEP 02-020: Capture E1M1 Spawn State Oracle
...
Capture E1M1 Spawn State Oracle

## goal

Deliver the smallest verified increment for capture e1m1 spawn state oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-e1m1-spawn-state-oracle.json
- test/vanilla_parity/oracles/capture-e1m1-spawn-state-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-e1m1-spawn-state-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-020 with test/vanilla_parity/oracles/capture-e1m1-spawn-state-oracle.test.ts proving the new behavior or audit result.
