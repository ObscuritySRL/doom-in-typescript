# [ ] STEP 09-033: Implement Automap Markers
...
Implement Automap Markers

## goal

Deliver the smallest verified increment for implement automap markers while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-automap-markers.ts
- test/vanilla_parity/render/implement-automap-markers.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-automap-markers.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-033 with test/vanilla_parity/render/implement-automap-markers.test.ts proving the new behavior or audit result.
