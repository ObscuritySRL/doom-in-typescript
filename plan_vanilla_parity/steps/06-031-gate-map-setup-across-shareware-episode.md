# [ ] STEP 06-031: Gate Map Setup Across Shareware Episode
...
Gate Map Setup Across Shareware Episode

## goal

Deliver the smallest verified increment for gate map setup across shareware episode while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/gate-map-setup-across-shareware-episode.ts
- test/vanilla_parity/map/gate-map-setup-across-shareware-episode.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/gate-map-setup-across-shareware-episode.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-031 with test/vanilla_parity/map/gate-map-setup-across-shareware-episode.test.ts proving the new behavior or audit result.
