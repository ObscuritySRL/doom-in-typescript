# [ ] STEP 10-009: Implement Screen Size Detail Gamma Menu
...
Implement Screen Size Detail Gamma Menu

## goal

Deliver the smallest verified increment for implement screen size detail gamma menu while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-screen-size-detail-gamma-menu.ts
- test/vanilla_parity/ui/implement-screen-size-detail-gamma-menu.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-screen-size-detail-gamma-menu.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-009 with test/vanilla_parity/ui/implement-screen-size-detail-gamma-menu.test.ts proving the new behavior or audit result.
