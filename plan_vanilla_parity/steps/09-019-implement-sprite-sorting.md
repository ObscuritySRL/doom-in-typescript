# [ ] STEP 09-019: Implement Sprite Sorting
...
Deliver the smallest verified increment for implement sprite sorting while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/implement-sprite-sorting.ts
- test/vanilla_parity/render/implement-sprite-sorting.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-sprite-sorting.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-019 with test/vanilla_parity/render/implement-sprite-sorting.test.ts proving the new behavior or audit result.
