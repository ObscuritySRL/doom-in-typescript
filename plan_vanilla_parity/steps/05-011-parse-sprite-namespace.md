# [ ] STEP 05-011: Parse Sprite Namespace
...
Parse Sprite Namespace

## goal

Deliver the smallest verified increment for parse sprite namespace while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/parse-sprite-namespace.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/parse-sprite-namespace.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-011 with test/vanilla_parity/wad/parse-sprite-namespace.test.ts proving the new behavior or audit result.
