# [ ] STEP 10-013: Implement Quit Confirmation
...
Deliver the smallest verified increment for implement quit confirmation while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-quit-confirmation.ts
- test/vanilla_parity/ui/implement-quit-confirmation.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-quit-confirmation.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-013 with test/vanilla_parity/ui/implement-quit-confirmation.test.ts proving the new behavior or audit result.
