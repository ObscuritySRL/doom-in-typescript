# [ ] STEP 05-027: Gate WAD And Asset Loading
...
Gate WAD And Asset Loading

## goal

Deliver the smallest verified increment for gate wad and asset loading while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/assets/gate-wad-and-asset-loading.ts
- test/vanilla_parity/wad/gate-wad-and-asset-loading.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/gate-wad-and-asset-loading.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-027 with test/vanilla_parity/wad/gate-wad-and-asset-loading.test.ts proving the new behavior or audit result.
