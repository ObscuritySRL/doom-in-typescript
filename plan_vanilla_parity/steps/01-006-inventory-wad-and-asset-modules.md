# [ ] STEP 01-006: Inventory WAD And Asset Modules
...
Inventory WAD And Asset Modules

## goal

Deliver the smallest verified increment for inventory wad and asset modules while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-wad-and-asset-modules.json
- test/vanilla_parity/current-state/inventory-wad-and-asset-modules.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-wad-and-asset-modules.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-006 with test/vanilla_parity/current-state/inventory-wad-and-asset-modules.test.ts proving the new behavior or audit result.
