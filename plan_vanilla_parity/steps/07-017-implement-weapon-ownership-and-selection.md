# [ ] STEP 07-017: Implement Weapon Ownership And Selection
...
Implement Weapon Ownership And Selection

## goal

Deliver the smallest verified increment for implement weapon ownership and selection while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-weapon-ownership-and-selection.ts
- test/vanilla_parity/player/implement-weapon-ownership-and-selection.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-weapon-ownership-and-selection.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-017 with test/vanilla_parity/player/implement-weapon-ownership-and-selection.test.ts proving the new behavior or audit result.
