# [ ] STEP 04-023: Enforce Vanilla Demo Size Limit
...
Deliver the smallest verified increment for enforce vanilla demo size limit while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/demo/enforce-vanilla-demo-size-limit.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/enforce-vanilla-demo-size-limit.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-023 with test/vanilla_parity/core/enforce-vanilla-demo-size-limit.test.ts proving the new behavior or audit result.
