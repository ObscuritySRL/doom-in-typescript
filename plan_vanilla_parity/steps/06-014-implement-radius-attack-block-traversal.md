# [ ] STEP 06-014: Implement Radius Attack Block Traversal
...
Implement Radius Attack Block Traversal

## goal

Deliver the smallest verified increment for implement radius attack block traversal while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-radius-attack-block-traversal.ts
- test/vanilla_parity/map/implement-radius-attack-block-traversal.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-radius-attack-block-traversal.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-014 with test/vanilla_parity/map/implement-radius-attack-block-traversal.test.ts proving the new behavior or audit result.
