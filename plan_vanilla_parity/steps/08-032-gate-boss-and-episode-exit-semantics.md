# [ ] STEP 08-032: Gate Boss And Episode Exit Semantics
...
Gate Boss And Episode Exit Semantics

## goal

Deliver the smallest verified increment for gate boss and episode exit semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/gate-boss-and-episode-exit-semantics.ts
- test/vanilla_parity/ai/gate-boss-and-episode-exit-semantics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/gate-boss-and-episode-exit-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-032 with test/vanilla_parity/ai/gate-boss-and-episode-exit-semantics.test.ts proving the new behavior or audit result.
