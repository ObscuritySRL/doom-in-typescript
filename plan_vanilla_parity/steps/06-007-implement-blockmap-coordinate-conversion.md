# [ ] STEP 06-007: Implement Blockmap Coordinate Conversion
...
Implement Blockmap Coordinate Conversion

## goal

Deliver the smallest verified increment for implement blockmap coordinate conversion while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-blockmap-coordinate-conversion.ts
- test/vanilla_parity/map/implement-blockmap-coordinate-conversion.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-blockmap-coordinate-conversion.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-007 with test/vanilla_parity/map/implement-blockmap-coordinate-conversion.test.ts proving the new behavior or audit result.
