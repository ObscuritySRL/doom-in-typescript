# [ ] STEP 12-026: Compare Save Load Roundtrip Oracle
...
Compare Save Load Roundtrip Oracle

## goal

Deliver the smallest verified increment for compare save load roundtrip oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/save/compare-save-load-roundtrip-oracle.ts
- test/vanilla_parity/save/compare-save-load-roundtrip-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/compare-save-load-roundtrip-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-026 with test/vanilla_parity/save/compare-save-load-roundtrip-oracle.test.ts proving the new behavior or audit result.
