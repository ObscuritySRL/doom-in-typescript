# [ ] STEP 10-022: Implement Intermission Stats Counting
...
Implement Intermission Stats Counting

## goal

Deliver the smallest verified increment for implement intermission stats counting while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-intermission-stats-counting.ts
- test/vanilla_parity/ui/implement-intermission-stats-counting.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-intermission-stats-counting.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-022 with test/vanilla_parity/ui/implement-intermission-stats-counting.test.ts proving the new behavior or audit result.
