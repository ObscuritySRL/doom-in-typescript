# [ ] STEP 03-031: Implement Clean Launch To Title Loop
...
Implement Clean Launch To Title Loop

## goal

Deliver the smallest verified increment for implement clean launch to title loop while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-clean-launch-to-title-loop.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-031 with test/vanilla_parity/launch/implement-clean-launch-to-title-loop.test.ts proving the new behavior or audit result.
