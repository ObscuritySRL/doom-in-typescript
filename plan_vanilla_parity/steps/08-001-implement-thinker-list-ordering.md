# [ ] STEP 08-001: Implement Thinker List Ordering
...
Implement Thinker List Ordering

## goal

Deliver the smallest verified increment for implement thinker list ordering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-thinker-list-ordering.ts
- test/vanilla_parity/ai/implement-thinker-list-ordering.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-thinker-list-ordering.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-001 with test/vanilla_parity/ai/implement-thinker-list-ordering.test.ts proving the new behavior or audit result.
