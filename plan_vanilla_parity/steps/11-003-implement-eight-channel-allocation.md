# [ ] STEP 11-003: Implement Eight Channel Allocation
...
Implement Eight Channel Allocation

## goal

Deliver the smallest verified increment for implement eight channel allocation while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-eight-channel-allocation.ts
- test/vanilla_parity/audio/implement-eight-channel-allocation.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-eight-channel-allocation.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-003 with test/vanilla_parity/audio/implement-eight-channel-allocation.test.ts proving the new behavior or audit result.
