...
Parse Flat Namespace

## goal

Deliver the smallest verified increment for parse flat namespace while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/parse-flat-namespace.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/parse-flat-namespace.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-007 with test/vanilla_parity/wad/parse-flat-namespace.test.ts proving the new behavior or audit result.
