# [ ] STEP 09-035: Compare Title And E1M1 Framebuffers
...
Compare Title And E1M1 Framebuffers

## goal

Deliver the smallest verified increment for compare title and e1m1 framebuffers while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/compare-title-and-e1m1-framebuffers.ts
- test/vanilla_parity/render/compare-title-and-e1m1-framebuffers.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/compare-title-and-e1m1-framebuffers.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-035 with test/vanilla_parity/render/compare-title-and-e1m1-framebuffers.test.ts proving the new behavior or audit result.
