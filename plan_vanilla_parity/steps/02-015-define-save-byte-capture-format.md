# [ ] STEP 02-015: Define Save Byte Capture Format
...
Define Save Byte Capture Format

## goal

Deliver the smallest verified increment for define save byte capture format while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/define-save-byte-capture-format.json
- test/vanilla_parity/oracles/define-save-byte-capture-format.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/define-save-byte-capture-format.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-015 with test/vanilla_parity/oracles/define-save-byte-capture-format.test.ts proving the new behavior or audit result.
