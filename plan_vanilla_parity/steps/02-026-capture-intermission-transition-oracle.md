# [ ] STEP 02-026: Capture Intermission Transition Oracle
...
Capture Intermission Transition Oracle

## goal

Deliver the smallest verified increment for capture intermission transition oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-intermission-transition-oracle.json
- test/vanilla_parity/oracles/capture-intermission-transition-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-intermission-transition-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-026 with test/vanilla_parity/oracles/capture-intermission-transition-oracle.test.ts proving the new behavior or audit result.
