# [ ] STEP 07-003: Implement Ticcmd Application
...
Implement Ticcmd Application

## goal

Deliver the smallest verified increment for implement ticcmd application while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-ticcmd-application.ts
- test/vanilla_parity/player/implement-ticcmd-application.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-ticcmd-application.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-003 with test/vanilla_parity/player/implement-ticcmd-application.test.ts proving the new behavior or audit result.
