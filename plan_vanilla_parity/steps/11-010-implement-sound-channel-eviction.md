# [ ] STEP 11-010: Implement Sound Channel Eviction
...
Implement Sound Channel Eviction

## goal

Deliver the smallest verified increment for implement sound channel eviction while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-sound-channel-eviction.ts
- test/vanilla_parity/audio/implement-sound-channel-eviction.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-sound-channel-eviction.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-010 with test/vanilla_parity/audio/implement-sound-channel-eviction.test.ts proving the new behavior or audit result.
