# [ ] STEP 13-003: Gate Ultimate Doom User Supplied Iwad Scope
...
Deliver the smallest verified increment for gate ultimate doom user supplied iwad scope while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/acceptance/gate-ultimate-doom-user-supplied-iwad-scope.json
- test/vanilla_parity/acceptance/gate-ultimate-doom-user-supplied-iwad-scope.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/acceptance/gate-ultimate-doom-user-supplied-iwad-scope.test.ts`
- `bun test`
...
- A committed and pushed change set for 13-003 with test/vanilla_parity/acceptance/gate-ultimate-doom-user-supplied-iwad-scope.test.ts proving the new behavior or audit result.
