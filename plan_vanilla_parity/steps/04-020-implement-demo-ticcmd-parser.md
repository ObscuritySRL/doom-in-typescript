# [ ] STEP 04-020: Implement Demo Ticcmd Parser
...
Implement Demo Ticcmd Parser

## goal

Deliver the smallest verified increment for implement demo ticcmd parser while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/demo/implement-demo-ticcmd-parser.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/implement-demo-ticcmd-parser.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-020 with test/vanilla_parity/core/implement-demo-ticcmd-parser.test.ts proving the new behavior or audit result.
