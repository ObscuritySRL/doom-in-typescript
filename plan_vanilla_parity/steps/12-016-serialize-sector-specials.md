# [ ] STEP 12-016: Serialize Sector Specials
...
Serialize Sector Specials

## goal

Deliver the smallest verified increment for serialize sector specials while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/save/serialize-sector-specials.ts
- test/vanilla_parity/save/serialize-sector-specials.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/serialize-sector-specials.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-016 with test/vanilla_parity/save/serialize-sector-specials.test.ts proving the new behavior or audit result.
