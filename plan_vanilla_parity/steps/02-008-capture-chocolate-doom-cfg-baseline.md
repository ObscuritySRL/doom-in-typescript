# [ ] STEP 02-008: Capture Chocolate Doom Cfg Baseline
...
Capture Chocolate Doom Cfg Baseline

## goal

Deliver the smallest verified increment for capture chocolate doom cfg baseline while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-chocolate-doom-cfg-baseline.json
- test/vanilla_parity/oracles/capture-chocolate-doom-cfg-baseline.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-chocolate-doom-cfg-baseline.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-008 with test/vanilla_parity/oracles/capture-chocolate-doom-cfg-baseline.test.ts proving the new behavior or audit result.
