# [ ] STEP 08-023: Implement Platform Specials
...
Implement Platform Specials

## goal

Deliver the smallest verified increment for implement platform specials while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/specials/implement-platform-specials.ts
- test/vanilla_parity/ai/implement-platform-specials.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-platform-specials.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-023 with test/vanilla_parity/ai/implement-platform-specials.test.ts proving the new behavior or audit result.
