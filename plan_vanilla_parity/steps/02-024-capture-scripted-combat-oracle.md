# [ ] STEP 02-024: Capture Scripted Combat Oracle
...
Capture Scripted Combat Oracle

## goal

Deliver the smallest verified increment for capture scripted combat oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-scripted-combat-oracle.json
- test/vanilla_parity/oracles/capture-scripted-combat-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-scripted-combat-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-024 with test/vanilla_parity/oracles/capture-scripted-combat-oracle.test.ts proving the new behavior or audit result.
