# [ ] STEP 02-033: Capture Full E1 Route Oracle
...
Capture Full E1 Route Oracle

## goal

Deliver the smallest verified increment for capture full e1 route oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-full-e1-route-oracle.json
- test/vanilla_parity/oracles/capture-full-e1-route-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-full-e1-route-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-033 with test/vanilla_parity/oracles/capture-full-e1-route-oracle.test.ts proving the new behavior or audit result.
