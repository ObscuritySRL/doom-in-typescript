# [ ] STEP 06-021: Implement Thing Touch Special Resolution
...
Implement Thing Touch Special Resolution

## goal

Deliver the smallest verified increment for implement thing touch special resolution while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-thing-touch-special-resolution.ts
- test/vanilla_parity/map/implement-thing-touch-special-resolution.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-thing-touch-special-resolution.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-021 with test/vanilla_parity/map/implement-thing-touch-special-resolution.test.ts proving the new behavior or audit result.
