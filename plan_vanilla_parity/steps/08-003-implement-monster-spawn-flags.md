# [ ] STEP 08-003: Implement Monster Spawn Flags
...
Implement Monster Spawn Flags

## goal

Deliver the smallest verified increment for implement monster spawn flags while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-monster-spawn-flags.ts
- test/vanilla_parity/ai/implement-monster-spawn-flags.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-monster-spawn-flags.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-003 with test/vanilla_parity/ai/implement-monster-spawn-flags.test.ts proving the new behavior or audit result.
