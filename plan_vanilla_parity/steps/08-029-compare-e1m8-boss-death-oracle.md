# [ ] STEP 08-029: Compare E1M8 Boss Death Oracle
...
Compare E1M8 Boss Death Oracle

## goal

Deliver the smallest verified increment for compare e1m8 boss death oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/compare-e1m8-boss-death-oracle.ts
- test/vanilla_parity/ai/compare-e1m8-boss-death-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/compare-e1m8-boss-death-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-029 with test/vanilla_parity/ai/compare-e1m8-boss-death-oracle.test.ts proving the new behavior or audit result.
