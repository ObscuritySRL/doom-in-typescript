# [ ] STEP 07-009: Implement God Mode And Powerup Flags
...
Implement God Mode And Powerup Flags

## goal

Deliver the smallest verified increment for implement god mode and powerup flags while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-god-mode-and-powerup-flags.ts
- test/vanilla_parity/player/implement-god-mode-and-powerup-flags.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-god-mode-and-powerup-flags.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-009 with test/vanilla_parity/player/implement-god-mode-and-powerup-flags.test.ts proving the new behavior or audit result.
