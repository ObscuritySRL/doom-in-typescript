# [ ] STEP 06-030: Gate Line Use And Trigger Collision
...
Gate Line Use And Trigger Collision

## goal

Deliver the smallest verified increment for gate line use and trigger collision while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/world/gate-line-use-and-trigger-collision.ts
- test/vanilla_parity/map/gate-line-use-and-trigger-collision.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/gate-line-use-and-trigger-collision.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-030 with test/vanilla_parity/map/gate-line-use-and-trigger-collision.test.ts proving the new behavior or audit result.
