# [ ] STEP 03-012: Create Win32 Window With Vanilla Framebuffer Contract
...
Create Win32 Window With Vanilla Framebuffer Contract

## goal

Deliver the smallest verified increment for create win32 window with vanilla framebuffer contract while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/bootstrap/create-win32-window-with-vanilla-framebuffer-contract.ts
- test/vanilla_parity/launch/create-win32-window-with-vanilla-framebuffer-contract.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/create-win32-window-with-vanilla-framebuffer-contract.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-012 with test/vanilla_parity/launch/create-win32-window-with-vanilla-framebuffer-contract.test.ts proving the new behavior or audit result.
