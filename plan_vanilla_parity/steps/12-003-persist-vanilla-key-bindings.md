# [ ] STEP 12-003: Persist Vanilla Key Bindings
...
Persist Vanilla Key Bindings

## goal

Deliver the smallest verified increment for persist vanilla key bindings while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/config/persist-vanilla-key-bindings.ts
- test/vanilla_parity/save/persist-vanilla-key-bindings.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/persist-vanilla-key-bindings.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-003 with test/vanilla_parity/save/persist-vanilla-key-bindings.test.ts proving the new behavior or audit result.
