# [ ] STEP 01-002: Inventory Simplified Launcher Surface
...
Inventory Simplified Launcher Surface

## goal

Deliver the smallest verified increment for inventory simplified launcher surface while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-simplified-launcher-surface.json
- test/vanilla_parity/current-state/inventory-simplified-launcher-surface.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-simplified-launcher-surface.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-002 with test/vanilla_parity/current-state/inventory-simplified-launcher-surface.test.ts proving the new behavior or audit result.
