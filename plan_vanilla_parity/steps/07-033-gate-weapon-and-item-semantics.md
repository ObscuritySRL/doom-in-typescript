# [ ] STEP 07-033: Gate Weapon And Item Semantics
...
Gate Weapon And Item Semantics

## goal

Deliver the smallest verified increment for gate weapon and item semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/gate-weapon-and-item-semantics.ts
- test/vanilla_parity/player/gate-weapon-and-item-semantics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/gate-weapon-and-item-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-033 with test/vanilla_parity/player/gate-weapon-and-item-semantics.test.ts proving the new behavior or audit result.
