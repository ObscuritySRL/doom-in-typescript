# [ ] STEP 10-008: Implement Sound Volume Menu
...
Implement Sound Volume Menu

## goal

Deliver the smallest verified increment for implement sound volume menu while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-sound-volume-menu.ts
- test/vanilla_parity/ui/implement-sound-volume-menu.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-sound-volume-menu.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-008 with test/vanilla_parity/ui/implement-sound-volume-menu.test.ts proving the new behavior or audit result.
