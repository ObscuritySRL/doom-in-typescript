# [ ] STEP 11-001: Implement Sound Effect Lump Loader
...
Implement Sound Effect Lump Loader

## goal

Deliver the smallest verified increment for implement sound effect lump loader while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-sound-effect-lump-loader.ts
- test/vanilla_parity/audio/implement-sound-effect-lump-loader.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-sound-effect-lump-loader.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-001 with test/vanilla_parity/audio/implement-sound-effect-lump-loader.test.ts proving the new behavior or audit result.
