# [ ] STEP 05-019: Reject Missing Proprietary Assets With Clear Error
...
Reject Missing Proprietary Assets With Clear Error

## goal

Deliver the smallest verified increment for reject missing proprietary assets with clear error while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/reject-missing-proprietary-assets-with-clear-error.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/reject-missing-proprietary-assets-with-clear-error.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-019 with test/vanilla_parity/wad/reject-missing-proprietary-assets-with-clear-error.test.ts proving the new behavior or audit result.
