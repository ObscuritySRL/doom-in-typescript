# [ ] STEP 07-031: Compare Scripted Combat Oracle
...
Compare Scripted Combat Oracle

## goal

Deliver the smallest verified increment for compare scripted combat oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/compare-scripted-combat-oracle.ts
- test/vanilla_parity/player/compare-scripted-combat-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/compare-scripted-combat-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-031 with test/vanilla_parity/player/compare-scripted-combat-oracle.test.ts proving the new behavior or audit result.
