# [ ] STEP 10-006: Implement Skill Menu
...
Implement Skill Menu

## goal

Deliver the smallest verified increment for implement skill menu while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-skill-menu.ts
- test/vanilla_parity/ui/implement-skill-menu.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-skill-menu.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-006 with test/vanilla_parity/ui/implement-skill-menu.test.ts proving the new behavior or audit result.
