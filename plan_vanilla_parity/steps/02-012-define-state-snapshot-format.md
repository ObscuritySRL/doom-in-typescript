# [ ] STEP 02-012: Define State Snapshot Format
...
Deliver the smallest verified increment for define state snapshot format while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/define-state-snapshot-format.json
- test/vanilla_parity/oracles/define-state-snapshot-format.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/define-state-snapshot-format.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-012 with test/vanilla_parity/oracles/define-state-snapshot-format.test.ts proving the new behavior or audit result.
