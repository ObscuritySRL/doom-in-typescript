...
Implement D DoomLoop Entry Timing

## goal

Deliver the smallest verified increment for implement d doomloop entry timing while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/bootstrap/implement-d-doomloop-entry-timing.ts
- test/vanilla_parity/launch/implement-d-doomloop-entry-timing.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-d-doomloop-entry-timing.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-009 with test/vanilla_parity/launch/implement-d-doomloop-entry-timing.test.ts proving the new behavior or audit result.
