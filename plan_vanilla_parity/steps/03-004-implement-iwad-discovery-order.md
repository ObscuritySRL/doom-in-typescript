# [ ] STEP 03-004: Implement Iwad Discovery Order
...
Implement Iwad Discovery Order

## goal

Deliver the smallest verified increment for implement iwad discovery order while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/launch/implement-iwad-discovery-order.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-iwad-discovery-order.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-004 with test/vanilla_parity/launch/implement-iwad-discovery-order.test.ts proving the new behavior or audit result.
