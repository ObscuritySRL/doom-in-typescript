# [ ] STEP 08-006: Implement Chase Direction Selection
...
Implement Chase Direction Selection

## goal

Deliver the smallest verified increment for implement chase direction selection while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-chase-direction-selection.ts
- test/vanilla_parity/ai/implement-chase-direction-selection.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-chase-direction-selection.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-006 with test/vanilla_parity/ai/implement-chase-direction-selection.test.ts proving the new behavior or audit result.
