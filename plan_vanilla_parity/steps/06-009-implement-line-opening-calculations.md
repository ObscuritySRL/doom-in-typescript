# [ ] STEP 06-009: Implement Line Opening Calculations
...
Implement Line Opening Calculations

## goal

Deliver the smallest verified increment for implement line opening calculations while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-line-opening-calculations.ts
- test/vanilla_parity/map/implement-line-opening-calculations.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-line-opening-calculations.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-009 with test/vanilla_parity/map/implement-line-opening-calculations.test.ts proving the new behavior or audit result.
