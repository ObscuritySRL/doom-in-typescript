# [ ] STEP 11-002: Implement Sound Priority Table
...
Implement Sound Priority Table

## goal

Deliver the smallest verified increment for implement sound priority table while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-sound-priority-table.ts
- test/vanilla_parity/audio/implement-sound-priority-table.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-sound-priority-table.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-002 with test/vanilla_parity/audio/implement-sound-priority-table.test.ts proving the new behavior or audit result.
