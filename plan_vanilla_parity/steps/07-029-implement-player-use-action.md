# [ ] STEP 07-029: Implement Player Use Action
...
Implement Player Use Action

## goal

Deliver the smallest verified increment for implement player use action while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/player/implement-player-use-action.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-player-use-action.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-029 with test/vanilla_parity/player/implement-player-use-action.test.ts proving the new behavior or audit result.
