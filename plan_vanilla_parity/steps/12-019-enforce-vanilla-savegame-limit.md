# [ ] STEP 12-019: Enforce Vanilla Savegame Limit
...
Enforce Vanilla Savegame Limit

## goal

Deliver the smallest verified increment for enforce vanilla savegame limit while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/save/enforce-vanilla-savegame-limit.ts
- test/vanilla_parity/save/enforce-vanilla-savegame-limit.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/enforce-vanilla-savegame-limit.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-019 with test/vanilla_parity/save/enforce-vanilla-savegame-limit.test.ts proving the new behavior or audit result.
