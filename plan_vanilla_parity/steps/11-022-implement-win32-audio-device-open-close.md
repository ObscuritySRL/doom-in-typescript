# [ ] STEP 11-022: Implement Win32 Audio Device Open Close
...
Implement Win32 Audio Device Open Close

## goal

Deliver the smallest verified increment for implement win32 audio device open close while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/audio/implement-win32-audio-device-open-close.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-win32-audio-device-open-close.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-022 with test/vanilla_parity/audio/implement-win32-audio-device-open-close.test.ts proving the new behavior or audit result.
