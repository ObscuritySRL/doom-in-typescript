# [ ] STEP 09-037: Gate Renderer Framebuffer Parity
...
Gate Renderer Framebuffer Parity

## goal

Deliver the smallest verified increment for gate renderer framebuffer parity while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/gate-renderer-framebuffer-parity.ts
- test/vanilla_parity/render/gate-renderer-framebuffer-parity.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/gate-renderer-framebuffer-parity.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-037 with test/vanilla_parity/render/gate-renderer-framebuffer-parity.test.ts proving the new behavior or audit result.
