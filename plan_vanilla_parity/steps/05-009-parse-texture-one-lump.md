# [ ] STEP 05-009: Parse Texture One Lump
...
Parse Texture One Lump

## goal

Deliver the smallest verified increment for parse texture one lump while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/parse-texture-one-lump.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/parse-texture-one-lump.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-009 with test/vanilla_parity/wad/parse-texture-one-lump.test.ts proving the new behavior or audit result.
