# [ ] STEP 09-028: Implement Status Bar Face Widget
...
Implement Status Bar Face Widget

## goal

Deliver the smallest verified increment for implement status bar face widget while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-status-bar-face-widget.ts
- test/vanilla_parity/render/implement-status-bar-face-widget.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-status-bar-face-widget.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-028 with test/vanilla_parity/render/implement-status-bar-face-widget.test.ts proving the new behavior or audit result.
