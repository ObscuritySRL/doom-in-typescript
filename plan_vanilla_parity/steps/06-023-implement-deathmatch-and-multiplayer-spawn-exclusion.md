# [ ] STEP 06-023: Implement Deathmatch And Multiplayer Spawn Exclusion
...
Implement Deathmatch And Multiplayer Spawn Exclusion

## goal

Deliver the smallest verified increment for implement deathmatch and multiplayer spawn exclusion while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-deathmatch-and-multiplayer-spawn-exclusion.ts
- test/vanilla_parity/map/implement-deathmatch-and-multiplayer-spawn-exclusion.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-deathmatch-and-multiplayer-spawn-exclusion.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-023 with test/vanilla_parity/map/implement-deathmatch-and-multiplayer-spawn-exclusion.test.ts proving the new behavior or audit result.
