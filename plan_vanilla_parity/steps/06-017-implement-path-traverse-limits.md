# [ ] STEP 06-017: Implement Path Traverse Limits
...
Implement Path Traverse Limits

## goal

Deliver the smallest verified increment for implement path traverse limits while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-path-traverse-limits.ts
- test/vanilla_parity/map/implement-path-traverse-limits.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-path-traverse-limits.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-017 with test/vanilla_parity/map/implement-path-traverse-limits.test.ts proving the new behavior or audit result.
