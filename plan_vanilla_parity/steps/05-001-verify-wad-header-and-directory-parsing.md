# [ ] STEP 05-001: Verify WAD Header And Directory Parsing
...
Verify WAD Header And Directory Parsing

## goal

Deliver the smallest verified increment for verify wad header and directory parsing while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/verify-wad-header-and-directory-parsing.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/verify-wad-header-and-directory-parsing.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-001 with test/vanilla_parity/wad/verify-wad-header-and-directory-parsing.test.ts proving the new behavior or audit result.
