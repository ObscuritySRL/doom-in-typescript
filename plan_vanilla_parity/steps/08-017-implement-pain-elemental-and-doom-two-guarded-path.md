# [ ] STEP 08-017: Implement Pain Elemental And Doom Two Guarded Path
...
Implement Pain Elemental And Doom Two Guarded Path

## goal

Deliver the smallest verified increment for implement pain elemental and doom two guarded path while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-pain-elemental-and-doom-two-guarded-path.ts
- test/vanilla_parity/ai/implement-pain-elemental-and-doom-two-guarded-path.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-pain-elemental-and-doom-two-guarded-path.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-017 with test/vanilla_parity/ai/implement-pain-elemental-and-doom-two-guarded-path.test.ts proving the new behavior or audit result.
