# [ ] STEP 06-011: Implement Try Move Semantics
...
Implement Try Move Semantics

## goal

Deliver the smallest verified increment for implement try move semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/world/implement-try-move-semantics.ts
- test/vanilla_parity/map/implement-try-move-semantics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-try-move-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-011 with test/vanilla_parity/map/implement-try-move-semantics.test.ts proving the new behavior or audit result.
