# [ ] STEP 10-015: Implement Quick Save And Quick Load Prompts
...
Implement Quick Save And Quick Load Prompts

## goal

Deliver the smallest verified increment for implement quick save and quick load prompts while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-quick-save-and-quick-load-prompts.ts
- test/vanilla_parity/ui/implement-quick-save-and-quick-load-prompts.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-quick-save-and-quick-load-prompts.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-015 with test/vanilla_parity/ui/implement-quick-save-and-quick-load-prompts.test.ts proving the new behavior or audit result.
