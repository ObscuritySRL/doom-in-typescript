# [ ] STEP 10-019: Implement Pause Overlay
...
Deliver the smallest verified increment for implement pause overlay while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-pause-overlay.ts
- test/vanilla_parity/ui/implement-pause-overlay.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-pause-overlay.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-019 with test/vanilla_parity/ui/implement-pause-overlay.test.ts proving the new behavior or audit result.
