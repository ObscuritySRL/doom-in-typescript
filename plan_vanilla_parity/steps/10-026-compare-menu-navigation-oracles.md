# [ ] STEP 10-026: Compare Menu Navigation Oracles
...
Compare Menu Navigation Oracles

## goal

Deliver the smallest verified increment for compare menu navigation oracles while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/compare-menu-navigation-oracles.ts
- test/vanilla_parity/ui/compare-menu-navigation-oracles.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/compare-menu-navigation-oracles.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-026 with test/vanilla_parity/ui/compare-menu-navigation-oracles.test.ts proving the new behavior or audit result.
