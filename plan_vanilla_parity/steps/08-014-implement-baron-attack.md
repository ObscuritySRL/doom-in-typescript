# [ ] STEP 08-014: Implement Baron Attack
...
Implement Baron Attack

## goal

Deliver the smallest verified increment for implement baron attack while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-baron-attack.ts
- test/vanilla_parity/ai/implement-baron-attack.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-baron-attack.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-014 with test/vanilla_parity/ai/implement-baron-attack.test.ts proving the new behavior or audit result.
