# [ ] STEP 11-014: Parse MUS Event Stream
...
Parse MUS Event Stream

## goal

Deliver the smallest verified increment for parse mus event stream while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/parse-mus-event-stream.ts
- test/vanilla_parity/audio/parse-mus-event-stream.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/parse-mus-event-stream.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-014 with test/vanilla_parity/audio/parse-mus-event-stream.test.ts proving the new behavior or audit result.
