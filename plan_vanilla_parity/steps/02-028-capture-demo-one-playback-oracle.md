# [ ] STEP 02-028: Capture Demo One Playback Oracle
...
Capture Demo One Playback Oracle

## goal

Deliver the smallest verified increment for capture demo one playback oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-demo-one-playback-oracle.json
- test/vanilla_parity/oracles/capture-demo-one-playback-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-demo-one-playback-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-028 with test/vanilla_parity/oracles/capture-demo-one-playback-oracle.test.ts proving the new behavior or audit result.
