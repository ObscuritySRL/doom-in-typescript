# [ ] STEP 00-002: Declare Plan Fps And Plan Engine Prior Art Only
...
Deliver the smallest verified increment for declare plan fps and plan engine prior art only while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/declare-plan-fps-and-plan-engine-prior-art-only.md
- test/plan_vanilla_parity/declare-plan-fps-and-plan-engine-prior-art-only.test.ts
...
- `bun run format`
- `bun test test/plan_vanilla_parity/declare-plan-fps-and-plan-engine-prior-art-only.test.ts`
- `bun test`
...
- A committed and pushed change set for 00-002 with test/plan_vanilla_parity/declare-plan-fps-and-plan-engine-prior-art-only.test.ts proving the new behavior or audit result.
