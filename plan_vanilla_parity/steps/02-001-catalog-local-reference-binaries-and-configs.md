# [ ] STEP 02-001: Catalog Local Reference Binaries And Configs
...
Catalog Local Reference Binaries And Configs

## goal

Deliver the smallest verified increment for catalog local reference binaries and configs while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/catalog-local-reference-binaries-and-configs.json
- test/vanilla_parity/oracles/catalog-local-reference-binaries-and-configs.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/catalog-local-reference-binaries-and-configs.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-001 with test/vanilla_parity/oracles/catalog-local-reference-binaries-and-configs.test.ts proving the new behavior or audit result.
