# [ ] STEP 03-034: Implement Screenshot Capture Hook
...
Implement Screenshot Capture Hook

## goal

Deliver the smallest verified increment for implement screenshot capture hook while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-screenshot-capture-hook.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-034 with test/vanilla_parity/launch/implement-screenshot-capture-hook.test.ts proving the new behavior or audit result.
