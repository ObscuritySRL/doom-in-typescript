# [ ] STEP 08-020: Implement Door Specials
...
Implement Door Specials

## goal

Deliver the smallest verified increment for implement door specials while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/specials/implement-door-specials.ts
- test/vanilla_parity/ai/implement-door-specials.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-door-specials.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-020 with test/vanilla_parity/ai/implement-door-specials.test.ts proving the new behavior or audit result.
