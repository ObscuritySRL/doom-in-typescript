# [ ] STEP 10-016: Implement Menu Skull Cursor Timing
...
Implement Menu Skull Cursor Timing

## goal

Deliver the smallest verified increment for implement menu skull cursor timing while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-menu-skull-cursor-timing.ts
- test/vanilla_parity/ui/implement-menu-skull-cursor-timing.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-menu-skull-cursor-timing.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-016 with test/vanilla_parity/ui/implement-menu-skull-cursor-timing.test.ts proving the new behavior or audit result.
