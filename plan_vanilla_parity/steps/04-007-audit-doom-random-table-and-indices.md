# [ ] STEP 04-007: Audit Doom Random Table And Indices
...
Audit Doom Random Table And Indices

## goal

Deliver the smallest verified increment for audit doom random table and indices while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/core/audit-doom-random-table-and-indices.ts
- test/vanilla_parity/core/audit-doom-random-table-and-indices.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/audit-doom-random-table-and-indices.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-007 with test/vanilla_parity/core/audit-doom-random-table-and-indices.test.ts proving the new behavior or audit result.
