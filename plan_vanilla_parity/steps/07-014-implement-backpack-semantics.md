# [ ] STEP 07-014: Implement Backpack Semantics
...
Implement Backpack Semantics

## goal

Deliver the smallest verified increment for implement backpack semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-backpack-semantics.ts
- test/vanilla_parity/player/implement-backpack-semantics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-backpack-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-014 with test/vanilla_parity/player/implement-backpack-semantics.test.ts proving the new behavior or audit result.
