# [ ] STEP 12-002: Parse Chocolate Doom Cfg
...
Parse Chocolate Doom Cfg

## goal

Deliver the smallest verified increment for parse chocolate doom cfg while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/config/parse-chocolate-doom-cfg.ts
- test/vanilla_parity/save/parse-chocolate-doom-cfg.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/parse-chocolate-doom-cfg.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-002 with test/vanilla_parity/save/parse-chocolate-doom-cfg.test.ts proving the new behavior or audit result.
