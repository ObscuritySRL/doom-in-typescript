# [ ] STEP 08-005: Implement Sound Target Propagation
...
Implement Sound Target Propagation

## goal

Deliver the smallest verified increment for implement sound target propagation while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-sound-target-propagation.ts
- test/vanilla_parity/ai/implement-sound-target-propagation.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-sound-target-propagation.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-005 with test/vanilla_parity/ai/implement-sound-target-propagation.test.ts proving the new behavior or audit result.
