# [ ] STEP 11-020: Implement OPL Instrument Mapping
...
Implement OPL Instrument Mapping

## goal

Deliver the smallest verified increment for implement opl instrument mapping while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-opl-instrument-mapping.ts
- test/vanilla_parity/audio/implement-opl-instrument-mapping.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-opl-instrument-mapping.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-020 with test/vanilla_parity/audio/implement-opl-instrument-mapping.test.ts proving the new behavior or audit result.
