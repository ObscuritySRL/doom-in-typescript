# [ ] STEP 02-014: Define Music Event Capture Format
...
Define Music Event Capture Format

## goal

Deliver the smallest verified increment for define music event capture format while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/define-music-event-capture-format.json
- test/vanilla_parity/oracles/define-music-event-capture-format.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/define-music-event-capture-format.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-014 with test/vanilla_parity/oracles/define-music-event-capture-format.test.ts proving the new behavior or audit result.
