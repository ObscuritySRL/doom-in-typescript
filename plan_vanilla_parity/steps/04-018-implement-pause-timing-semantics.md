# [ ] STEP 04-018: Implement Pause Timing Semantics
...
Implement Pause Timing Semantics

## goal

Deliver the smallest verified increment for implement pause timing semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/core/implement-pause-timing-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-018 with test/vanilla_parity/core/implement-pause-timing-semantics.test.ts proving the new behavior or audit result.
