# [ ] STEP 08-012: Implement Lost Soul Attack
...
Implement Lost Soul Attack

## goal

Deliver the smallest verified increment for implement lost soul attack while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-lost-soul-attack.ts
- test/vanilla_parity/ai/implement-lost-soul-attack.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-lost-soul-attack.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-012 with test/vanilla_parity/ai/implement-lost-soul-attack.test.ts proving the new behavior or audit result.
