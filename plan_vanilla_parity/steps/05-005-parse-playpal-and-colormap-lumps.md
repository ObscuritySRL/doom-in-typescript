# [ ] STEP 05-005: Parse Playpal And Colormap Lumps
...
Parse Playpal And Colormap Lumps

## goal

Deliver the smallest verified increment for parse playpal and colormap lumps while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/parse-playpal-and-colormap-lumps.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/parse-playpal-and-colormap-lumps.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-005 with test/vanilla_parity/wad/parse-playpal-and-colormap-lumps.test.ts proving the new behavior or audit result.
