# [ ] STEP 10-007: Implement Options Menu
...
Deliver the smallest verified increment for implement options menu while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-options-menu.ts
- test/vanilla_parity/ui/implement-options-menu.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-options-menu.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-007 with test/vanilla_parity/ui/implement-options-menu.test.ts proving the new behavior or audit result.
