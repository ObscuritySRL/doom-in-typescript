# [ ] STEP 02-002: Verify Local Reference File Hashes
...
Verify Local Reference File Hashes

## goal

Deliver the smallest verified increment for verify local reference file hashes while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/verify-local-reference-file-hashes.json
- test/vanilla_parity/oracles/verify-local-reference-file-hashes.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/verify-local-reference-file-hashes.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-002 with test/vanilla_parity/oracles/verify-local-reference-file-hashes.test.ts proving the new behavior or audit result.
