# [ ] STEP 05-026: Compare Local Doom1 Wad Manifest
...
Compare Local Doom1 Wad Manifest

## goal

Deliver the smallest verified increment for compare local doom1 wad manifest while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/compare-local-doom1-wad-manifest.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/compare-local-doom1-wad-manifest.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-026 with test/vanilla_parity/wad/compare-local-doom1-wad-manifest.test.ts proving the new behavior or audit result.
