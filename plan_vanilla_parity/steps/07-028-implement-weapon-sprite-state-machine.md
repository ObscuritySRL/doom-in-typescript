# [ ] STEP 07-028: Implement Weapon Sprite State Machine
...
Implement Weapon Sprite State Machine

## goal

Deliver the smallest verified increment for implement weapon sprite state machine while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-weapon-sprite-state-machine.ts
- test/vanilla_parity/player/implement-weapon-sprite-state-machine.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-weapon-sprite-state-machine.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-028 with test/vanilla_parity/player/implement-weapon-sprite-state-machine.test.ts proving the new behavior or audit result.
