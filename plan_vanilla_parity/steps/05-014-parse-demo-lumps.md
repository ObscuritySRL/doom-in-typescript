...
Deliver the smallest verified increment for parse demo lumps while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/parse-demo-lumps.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/parse-demo-lumps.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-014 with test/vanilla_parity/wad/parse-demo-lumps.test.ts proving the new behavior or audit result.
