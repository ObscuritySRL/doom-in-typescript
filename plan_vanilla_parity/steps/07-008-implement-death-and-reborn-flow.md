# [ ] STEP 07-008: Implement Death And Reborn Flow
...
Implement Death And Reborn Flow

## goal

Deliver the smallest verified increment for implement death and reborn flow while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-death-and-reborn-flow.ts
- test/vanilla_parity/player/implement-death-and-reborn-flow.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-death-and-reborn-flow.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-008 with test/vanilla_parity/player/implement-death-and-reborn-flow.test.ts proving the new behavior or audit result.
