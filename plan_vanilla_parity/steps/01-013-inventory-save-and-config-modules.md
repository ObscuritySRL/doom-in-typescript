# [ ] STEP 01-013: Inventory Save And Config Modules
...
Inventory Save And Config Modules

## goal

Deliver the smallest verified increment for inventory save and config modules while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-save-and-config-modules.json
- test/vanilla_parity/current-state/inventory-save-and-config-modules.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-save-and-config-modules.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-013 with test/vanilla_parity/current-state/inventory-save-and-config-modules.test.ts proving the new behavior or audit result.
