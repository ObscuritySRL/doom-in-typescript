# [ ] STEP 09-022: Implement Player Weapon Sprite Rendering
...
Implement Player Weapon Sprite Rendering

## goal

Deliver the smallest verified increment for implement player weapon sprite rendering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/render/implement-player-weapon-sprite-rendering.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-player-weapon-sprite-rendering.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-022 with test/vanilla_parity/render/implement-player-weapon-sprite-rendering.test.ts proving the new behavior or audit result.
