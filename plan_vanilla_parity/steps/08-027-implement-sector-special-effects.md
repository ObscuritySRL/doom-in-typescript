# [ ] STEP 08-027: Implement Sector Special Effects
...
Implement Sector Special Effects

## goal

Deliver the smallest verified increment for implement sector special effects while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/specials/implement-sector-special-effects.ts
- test/vanilla_parity/ai/implement-sector-special-effects.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-sector-special-effects.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-027 with test/vanilla_parity/ai/implement-sector-special-effects.test.ts proving the new behavior or audit result.
