# [ ] STEP 03-025: Implement Mouse Grab And Release Policy
...
Implement Mouse Grab And Release Policy

## goal

Deliver the smallest verified increment for implement mouse grab and release policy while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-mouse-grab-and-release-policy.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-025 with test/vanilla_parity/launch/implement-mouse-grab-and-release-policy.test.ts proving the new behavior or audit result.
