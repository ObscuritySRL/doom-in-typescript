# [ ] STEP 10-021: Implement Chat Macro Storage For Config Compatibility
...
Implement Chat Macro Storage For Config Compatibility

## goal

Deliver the smallest verified increment for implement chat macro storage for config compatibility while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-chat-macro-storage-for-config-compatibility.ts
- test/vanilla_parity/ui/implement-chat-macro-storage-for-config-compatibility.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-chat-macro-storage-for-config-compatibility.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-021 with test/vanilla_parity/ui/implement-chat-macro-storage-for-config-compatibility.test.ts proving the new behavior or audit result.
