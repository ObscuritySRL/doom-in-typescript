# [ ] STEP 08-007: Implement Monster Melee Range
...
Implement Monster Melee Range

## goal

Deliver the smallest verified increment for implement monster melee range while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-monster-melee-range.ts
- test/vanilla_parity/ai/implement-monster-melee-range.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-monster-melee-range.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-007 with test/vanilla_parity/ai/implement-monster-melee-range.test.ts proving the new behavior or audit result.
