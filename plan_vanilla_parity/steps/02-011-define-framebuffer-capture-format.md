# [ ] STEP 02-011: Define Framebuffer Capture Format
...
Define Framebuffer Capture Format

## goal

Deliver the smallest verified increment for define framebuffer capture format while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/define-framebuffer-capture-format.json
- test/vanilla_parity/oracles/define-framebuffer-capture-format.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/define-framebuffer-capture-format.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-011 with test/vanilla_parity/oracles/define-framebuffer-capture-format.test.ts proving the new behavior or audit result.
