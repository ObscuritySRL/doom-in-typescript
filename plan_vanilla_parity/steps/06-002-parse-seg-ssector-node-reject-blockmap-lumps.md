# [ ] STEP 06-002: Parse Seg Ssector Node Reject Blockmap Lumps
...
Parse Seg Ssector Node Reject Blockmap Lumps

## goal

Deliver the smallest verified increment for parse seg ssector node reject blockmap lumps while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/parse-seg-ssector-node-reject-blockmap-lumps.ts
- test/vanilla_parity/map/parse-seg-ssector-node-reject-blockmap-lumps.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/parse-seg-ssector-node-reject-blockmap-lumps.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-002 with test/vanilla_parity/map/parse-seg-ssector-node-reject-blockmap-lumps.test.ts proving the new behavior or audit result.
