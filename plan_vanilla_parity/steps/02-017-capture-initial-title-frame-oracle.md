# [ ] STEP 02-017: Capture Initial Title Frame Oracle
...
Capture Initial Title Frame Oracle

## goal

Deliver the smallest verified increment for capture initial title frame oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-initial-title-frame-oracle.json
- test/vanilla_parity/oracles/capture-initial-title-frame-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-initial-title-frame-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-017 with test/vanilla_parity/oracles/capture-initial-title-frame-oracle.test.ts proving the new behavior or audit result.
