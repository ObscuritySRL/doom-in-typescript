# [ ] STEP 10-024: Implement Finale Text Timing
...
Implement Finale Text Timing

## goal

Deliver the smallest verified increment for implement finale text timing while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-finale-text-timing.ts
- test/vanilla_parity/ui/implement-finale-text-timing.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-finale-text-timing.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-024 with test/vanilla_parity/ui/implement-finale-text-timing.test.ts proving the new behavior or audit result.
