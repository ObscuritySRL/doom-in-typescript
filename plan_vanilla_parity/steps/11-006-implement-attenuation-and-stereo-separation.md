# [ ] STEP 11-006: Implement Attenuation And Stereo Separation
...
Implement Attenuation And Stereo Separation

## goal

Deliver the smallest verified increment for implement attenuation and stereo separation while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-attenuation-and-stereo-separation.ts
- test/vanilla_parity/audio/implement-attenuation-and-stereo-separation.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-attenuation-and-stereo-separation.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-006 with test/vanilla_parity/audio/implement-attenuation-and-stereo-separation.test.ts proving the new behavior or audit result.
