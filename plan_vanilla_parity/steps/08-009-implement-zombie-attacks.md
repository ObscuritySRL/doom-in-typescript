# [ ] STEP 08-009: Implement Zombie Attacks
...
Implement Zombie Attacks

## goal

Deliver the smallest verified increment for implement zombie attacks while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-zombie-attacks.ts
- test/vanilla_parity/ai/implement-zombie-attacks.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-zombie-attacks.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-009 with test/vanilla_parity/ai/implement-zombie-attacks.test.ts proving the new behavior or audit result.
