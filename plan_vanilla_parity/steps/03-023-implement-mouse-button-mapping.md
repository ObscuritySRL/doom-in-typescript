# [ ] STEP 03-023: Implement Mouse Button Mapping
...
Implement Mouse Button Mapping

## goal

Deliver the smallest verified increment for implement mouse button mapping while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-mouse-button-mapping.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-023 with test/vanilla_parity/launch/implement-mouse-button-mapping.test.ts proving the new behavior or audit result.
