# [ ] STEP 08-022: Implement Ceiling Specials
...
Implement Ceiling Specials

## goal

Deliver the smallest verified increment for implement ceiling specials while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/specials/implement-ceiling-specials.ts
- test/vanilla_parity/ai/implement-ceiling-specials.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-ceiling-specials.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-022 with test/vanilla_parity/ai/implement-ceiling-specials.test.ts proving the new behavior or audit result.
