# [ ] STEP 10-018: Implement Menu Repeat Timing
...
Implement Menu Repeat Timing

## goal

Deliver the smallest verified increment for implement menu repeat timing while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-menu-repeat-timing.ts
- test/vanilla_parity/ui/implement-menu-repeat-timing.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-menu-repeat-timing.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-018 with test/vanilla_parity/ui/implement-menu-repeat-timing.test.ts proving the new behavior or audit result.
