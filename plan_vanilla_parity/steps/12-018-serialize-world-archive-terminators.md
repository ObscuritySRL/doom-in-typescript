# [ ] STEP 12-018: Serialize World Archive Terminators
...
Serialize World Archive Terminators

## goal

Deliver the smallest verified increment for serialize world archive terminators while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/save/serialize-world-archive-terminators.ts
- test/vanilla_parity/save/serialize-world-archive-terminators.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/serialize-world-archive-terminators.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-018 with test/vanilla_parity/save/serialize-world-archive-terminators.test.ts proving the new behavior or audit result.
