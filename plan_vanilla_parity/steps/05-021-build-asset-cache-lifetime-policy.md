# [ ] STEP 05-021: Build Asset Cache Lifetime Policy
...
Build Asset Cache Lifetime Policy

## goal

Deliver the smallest verified increment for build asset cache lifetime policy while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/build-asset-cache-lifetime-policy.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/build-asset-cache-lifetime-policy.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-021 with test/vanilla_parity/wad/build-asset-cache-lifetime-policy.test.ts proving the new behavior or audit result.
