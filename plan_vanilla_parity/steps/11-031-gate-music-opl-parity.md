# [ ] STEP 11-031: Gate Music OPL Parity
...
Gate Music OPL Parity

## goal

Deliver the smallest verified increment for gate music opl parity while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/gate-music-opl-parity.ts
- test/vanilla_parity/audio/gate-music-opl-parity.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/gate-music-opl-parity.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-031 with test/vanilla_parity/audio/gate-music-opl-parity.test.ts proving the new behavior or audit result.
