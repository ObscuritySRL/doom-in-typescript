# [ ] STEP 08-016: Implement Spider Mastermind Attack For Registered Iwad
...
Implement Spider Mastermind Attack For Registered Iwad

## goal

Deliver the smallest verified increment for implement spider mastermind attack for registered iwad while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-spider-mastermind-attack-for-registered-iwad.ts
- test/vanilla_parity/ai/implement-spider-mastermind-attack-for-registered-iwad.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-spider-mastermind-attack-for-registered-iwad.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-016 with test/vanilla_parity/ai/implement-spider-mastermind-attack-for-registered-iwad.test.ts proving the new behavior or audit result.
