# [ ] STEP 06-005: Implement Subsector Point Query
...
Implement Subsector Point Query

## goal

Deliver the smallest verified increment for implement subsector point query while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-subsector-point-query.ts
- test/vanilla_parity/map/implement-subsector-point-query.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-subsector-point-query.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-005 with test/vanilla_parity/map/implement-subsector-point-query.test.ts proving the new behavior or audit result.
