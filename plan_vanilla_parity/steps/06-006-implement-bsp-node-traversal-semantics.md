# [ ] STEP 06-006: Implement BSP Node Traversal Semantics
...
Implement BSP Node Traversal Semantics

## goal

Deliver the smallest verified increment for implement bsp node traversal semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-bsp-node-traversal-semantics.ts
- test/vanilla_parity/map/implement-bsp-node-traversal-semantics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-bsp-node-traversal-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-006 with test/vanilla_parity/map/implement-bsp-node-traversal-semantics.test.ts proving the new behavior or audit result.
