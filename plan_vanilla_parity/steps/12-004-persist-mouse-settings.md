...
Deliver the smallest verified increment for persist mouse settings while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/config/persist-mouse-settings.ts
- test/vanilla_parity/save/persist-mouse-settings.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/persist-mouse-settings.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-004 with test/vanilla_parity/save/persist-mouse-settings.test.ts proving the new behavior or audit result.
