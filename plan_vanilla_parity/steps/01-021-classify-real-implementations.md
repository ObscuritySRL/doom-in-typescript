# [ ] STEP 01-021: Classify Real Implementations
...
Deliver the smallest verified increment for classify real implementations while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/classify-real-implementations.json
- test/vanilla_parity/current-state/classify-real-implementations.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/classify-real-implementations.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-021 with test/vanilla_parity/current-state/classify-real-implementations.test.ts proving the new behavior or audit result.
