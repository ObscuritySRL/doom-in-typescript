# [ ] STEP 02-029: Capture Demo Two Playback Oracle
...
Capture Demo Two Playback Oracle

## goal

Deliver the smallest verified increment for capture demo two playback oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-demo-two-playback-oracle.json
- test/vanilla_parity/oracles/capture-demo-two-playback-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-demo-two-playback-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-029 with test/vanilla_parity/oracles/capture-demo-two-playback-oracle.test.ts proving the new behavior or audit result.
