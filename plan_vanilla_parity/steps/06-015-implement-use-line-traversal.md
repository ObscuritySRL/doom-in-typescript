# [ ] STEP 06-015: Implement Use Line Traversal
...
Implement Use Line Traversal

## goal

Deliver the smallest verified increment for implement use line traversal while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-use-line-traversal.ts
- test/vanilla_parity/map/implement-use-line-traversal.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-use-line-traversal.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-015 with test/vanilla_parity/map/implement-use-line-traversal.test.ts proving the new behavior or audit result.
