# [ ] STEP 08-031: Gate Sector And Line Specials
...
Gate Sector And Line Specials

## goal

Deliver the smallest verified increment for gate sector and line specials while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/specials/gate-sector-and-line-specials.ts
- test/vanilla_parity/ai/gate-sector-and-line-specials.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/gate-sector-and-line-specials.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-031 with test/vanilla_parity/ai/gate-sector-and-line-specials.test.ts proving the new behavior or audit result.
