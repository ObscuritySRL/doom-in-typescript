# [ ] STEP 08-015: Implement Cyberdemon Attack For Registered Iwad
...
Implement Cyberdemon Attack For Registered Iwad

## goal

Deliver the smallest verified increment for implement cyberdemon attack for registered iwad while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-cyberdemon-attack-for-registered-iwad.ts
- test/vanilla_parity/ai/implement-cyberdemon-attack-for-registered-iwad.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-cyberdemon-attack-for-registered-iwad.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-015 with test/vanilla_parity/ai/implement-cyberdemon-attack-for-registered-iwad.test.ts proving the new behavior or audit result.
