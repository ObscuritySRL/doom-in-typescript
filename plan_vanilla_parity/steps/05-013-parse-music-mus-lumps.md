# [ ] STEP 05-013: Parse Music MUS Lumps
...
Parse Music MUS Lumps

## goal

Deliver the smallest verified increment for parse music mus lumps while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/parse-music-mus-lumps.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/parse-music-mus-lumps.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-013 with test/vanilla_parity/wad/parse-music-mus-lumps.test.ts proving the new behavior or audit result.
