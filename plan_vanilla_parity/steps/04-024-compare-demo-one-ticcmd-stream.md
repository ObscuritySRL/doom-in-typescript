# [ ] STEP 04-024: Compare Demo One Ticcmd Stream
...
Compare Demo One Ticcmd Stream

## goal

Deliver the smallest verified increment for compare demo one ticcmd stream while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/core/compare-demo-one-ticcmd-stream.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-024 with test/vanilla_parity/core/compare-demo-one-ticcmd-stream.test.ts proving the new behavior or audit result.
