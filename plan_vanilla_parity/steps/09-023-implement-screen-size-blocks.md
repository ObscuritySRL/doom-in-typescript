# [ ] STEP 09-023: Implement Screen Size Blocks
...
Implement Screen Size Blocks

## goal

Deliver the smallest verified increment for implement screen size blocks while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/implement-screen-size-blocks.ts
- test/vanilla_parity/render/implement-screen-size-blocks.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-screen-size-blocks.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-023 with test/vanilla_parity/render/implement-screen-size-blocks.test.ts proving the new behavior or audit result.
