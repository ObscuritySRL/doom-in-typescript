# [ ] STEP 07-007: Implement Player Damage And Armor
...
Implement Player Damage And Armor

## goal

Deliver the smallest verified increment for implement player damage and armor while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-player-damage-and-armor.ts
- test/vanilla_parity/player/implement-player-damage-and-armor.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-player-damage-and-armor.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-007 with test/vanilla_parity/player/implement-player-damage-and-armor.test.ts proving the new behavior or audit result.
