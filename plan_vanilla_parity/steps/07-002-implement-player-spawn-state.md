# [ ] STEP 07-002: Implement Player Spawn State
...
Implement Player Spawn State

## goal

Deliver the smallest verified increment for implement player spawn state while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-player-spawn-state.ts
- test/vanilla_parity/player/implement-player-spawn-state.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-player-spawn-state.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-002 with test/vanilla_parity/player/implement-player-spawn-state.test.ts proving the new behavior or audit result.
