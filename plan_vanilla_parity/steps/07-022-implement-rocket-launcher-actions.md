# [ ] STEP 07-022: Implement Rocket Launcher Actions
...
Implement Rocket Launcher Actions

## goal

Deliver the smallest verified increment for implement rocket launcher actions while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-rocket-launcher-actions.ts
- test/vanilla_parity/player/implement-rocket-launcher-actions.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-rocket-launcher-actions.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-022 with test/vanilla_parity/player/implement-rocket-launcher-actions.test.ts proving the new behavior or audit result.
