# [ ] STEP 03-033: Implement Menu Route To E1M1
...
Implement Menu Route To E1M1

## goal

Deliver the smallest verified increment for implement menu route to e1m1 while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-menu-route-to-e1m1.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-033 with test/vanilla_parity/launch/implement-menu-route-to-e1m1.test.ts proving the new behavior or audit result.
