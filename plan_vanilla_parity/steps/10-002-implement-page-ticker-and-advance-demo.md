# [ ] STEP 10-002: Implement Page Ticker And Advance Demo
...
Implement Page Ticker And Advance Demo

## goal

Deliver the smallest verified increment for implement page ticker and advance demo while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-page-ticker-and-advance-demo.ts
- test/vanilla_parity/ui/implement-page-ticker-and-advance-demo.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-page-ticker-and-advance-demo.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-002 with test/vanilla_parity/ui/implement-page-ticker-and-advance-demo.test.ts proving the new behavior or audit result.
