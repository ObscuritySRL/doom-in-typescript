# [ ] STEP 01-012: Inventory Audio Modules
...
Inventory Audio Modules

## goal

Deliver the smallest verified increment for inventory audio modules while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-audio-modules.json
- test/vanilla_parity/current-state/inventory-audio-modules.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-audio-modules.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-012 with test/vanilla_parity/current-state/inventory-audio-modules.test.ts proving the new behavior or audit result.
