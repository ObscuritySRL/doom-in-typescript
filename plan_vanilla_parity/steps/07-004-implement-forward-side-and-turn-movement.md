# [ ] STEP 07-004: Implement Forward Side And Turn Movement
...
Implement Forward Side And Turn Movement

## goal

Deliver the smallest verified increment for implement forward side and turn movement while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-forward-side-and-turn-movement.ts
- test/vanilla_parity/player/implement-forward-side-and-turn-movement.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-forward-side-and-turn-movement.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-004 with test/vanilla_parity/player/implement-forward-side-and-turn-movement.test.ts proving the new behavior or audit result.
