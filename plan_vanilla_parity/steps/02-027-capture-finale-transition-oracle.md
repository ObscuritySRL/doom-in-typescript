# [ ] STEP 02-027: Capture Finale Transition Oracle
...
Capture Finale Transition Oracle

## goal

Deliver the smallest verified increment for capture finale transition oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-finale-transition-oracle.json
- test/vanilla_parity/oracles/capture-finale-transition-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-finale-transition-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-027 with test/vanilla_parity/oracles/capture-finale-transition-oracle.test.ts proving the new behavior or audit result.
