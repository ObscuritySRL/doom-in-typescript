# [ ] STEP 06-008: Implement Block Things Linking
...
Implement Block Things Linking

## goal

Deliver the smallest verified increment for implement block things linking while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-block-things-linking.ts
- test/vanilla_parity/map/implement-block-things-linking.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-block-things-linking.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-008 with test/vanilla_parity/map/implement-block-things-linking.test.ts proving the new behavior or audit result.
