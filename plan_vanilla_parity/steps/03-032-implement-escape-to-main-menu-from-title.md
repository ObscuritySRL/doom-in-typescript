# [ ] STEP 03-032: Implement Escape To Main Menu From Title
...
Implement Escape To Main Menu From Title

## goal

Deliver the smallest verified increment for implement escape to main menu from title while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-escape-to-main-menu-from-title.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-032 with test/vanilla_parity/launch/implement-escape-to-main-menu-from-title.test.ts proving the new behavior or audit result.
