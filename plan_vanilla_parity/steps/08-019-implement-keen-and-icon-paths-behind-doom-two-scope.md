# [ ] STEP 08-019: Implement Keen And Icon Paths Behind Doom Two Scope
...
Implement Keen And Icon Paths Behind Doom Two Scope

## goal

Deliver the smallest verified increment for implement keen and icon paths behind doom two scope while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-keen-and-icon-paths-behind-doom-two-scope.ts
- test/vanilla_parity/ai/implement-keen-and-icon-paths-behind-doom-two-scope.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-keen-and-icon-paths-behind-doom-two-scope.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-019 with test/vanilla_parity/ai/implement-keen-and-icon-paths-behind-doom-two-scope.test.ts proving the new behavior or audit result.
