# [ ] STEP 12-025: Compare Reference Save Byte Oracle
...
Compare Reference Save Byte Oracle

## goal

Deliver the smallest verified increment for compare reference save byte oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/save/compare-reference-save-byte-oracle.ts
- test/vanilla_parity/save/compare-reference-save-byte-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/compare-reference-save-byte-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-025 with test/vanilla_parity/save/compare-reference-save-byte-oracle.test.ts proving the new behavior or audit result.
