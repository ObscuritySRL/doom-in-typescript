# [ ] STEP 07-032: Gate Player Movement And Damage
...
Gate Player Movement And Damage

## goal

Deliver the smallest verified increment for gate player movement and damage while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/gate-player-movement-and-damage.ts
- test/vanilla_parity/player/gate-player-movement-and-damage.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/gate-player-movement-and-damage.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-032 with test/vanilla_parity/player/gate-player-movement-and-damage.test.ts proving the new behavior or audit result.
