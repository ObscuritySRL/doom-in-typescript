# [ ] STEP 12-023: Restore Player Mobj And World State
...
Restore Player Mobj And World State

## goal

Deliver the smallest verified increment for restore player mobj and world state while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/save/restore-player-mobj-and-world-state.ts
- test/vanilla_parity/save/restore-player-mobj-and-world-state.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/save/restore-player-mobj-and-world-state.test.ts`
- `bun test`
...
- A committed and pushed change set for 12-023 with test/vanilla_parity/save/restore-player-mobj-and-world-state.test.ts proving the new behavior or audit result.
