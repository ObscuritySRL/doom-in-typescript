# [ ] STEP 02-022: Capture Scripted Use Line Oracle
...
Capture Scripted Use Line Oracle

## goal

Deliver the smallest verified increment for capture scripted use line oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-scripted-use-line-oracle.json
- test/vanilla_parity/oracles/capture-scripted-use-line-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-scripted-use-line-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-022 with test/vanilla_parity/oracles/capture-scripted-use-line-oracle.test.ts proving the new behavior or audit result.
