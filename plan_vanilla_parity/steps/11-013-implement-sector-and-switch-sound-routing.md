# [ ] STEP 11-013: Implement Sector And Switch Sound Routing
...
Implement Sector And Switch Sound Routing

## goal

Deliver the smallest verified increment for implement sector and switch sound routing while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-sector-and-switch-sound-routing.ts
- test/vanilla_parity/audio/implement-sector-and-switch-sound-routing.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-sector-and-switch-sound-routing.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-013 with test/vanilla_parity/audio/implement-sector-and-switch-sound-routing.test.ts proving the new behavior or audit result.
