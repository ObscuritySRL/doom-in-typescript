# [ ] STEP 06-020: Implement Sector Floor Ceiling Change Checks
...
Implement Sector Floor Ceiling Change Checks

## goal

Deliver the smallest verified increment for implement sector floor ceiling change checks while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-sector-floor-ceiling-change-checks.ts
- test/vanilla_parity/map/implement-sector-floor-ceiling-change-checks.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-sector-floor-ceiling-change-checks.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-020 with test/vanilla_parity/map/implement-sector-floor-ceiling-change-checks.test.ts proving the new behavior or audit result.
