# [ ] STEP 07-020: Implement Shotgun Actions
...
Implement Shotgun Actions

## goal

Deliver the smallest verified increment for implement shotgun actions while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-shotgun-actions.ts
- test/vanilla_parity/player/implement-shotgun-actions.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-shotgun-actions.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-020 with test/vanilla_parity/player/implement-shotgun-actions.test.ts proving the new behavior or audit result.
