# [ ] STEP 09-005: Implement Two Sided Wall Clipping
...
Implement Two Sided Wall Clipping

## goal

Deliver the smallest verified increment for implement two sided wall clipping while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/implement-two-sided-wall-clipping.ts
- test/vanilla_parity/render/implement-two-sided-wall-clipping.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-two-sided-wall-clipping.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-005 with test/vanilla_parity/render/implement-two-sided-wall-clipping.test.ts proving the new behavior or audit result.
