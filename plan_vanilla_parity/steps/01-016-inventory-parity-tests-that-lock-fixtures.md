# [ ] STEP 01-016: Inventory Parity Tests That Lock Fixtures
...
Inventory Parity Tests That Lock Fixtures

## goal

Deliver the smallest verified increment for inventory parity tests that lock fixtures while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-parity-tests-that-lock-fixtures.json
- test/vanilla_parity/current-state/inventory-parity-tests-that-lock-fixtures.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-parity-tests-that-lock-fixtures.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-016 with test/vanilla_parity/current-state/inventory-parity-tests-that-lock-fixtures.test.ts proving the new behavior or audit result.
