# [ ] STEP 10-011: Implement Load Game Menu
...
Deliver the smallest verified increment for implement load game menu while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-load-game-menu.ts
- test/vanilla_parity/ui/implement-load-game-menu.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-load-game-menu.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-011 with test/vanilla_parity/ui/implement-load-game-menu.test.ts proving the new behavior or audit result.
