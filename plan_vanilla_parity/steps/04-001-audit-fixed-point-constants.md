# [ ] STEP 04-001: Audit Fixed Point Constants
...
Audit Fixed Point Constants

## goal

Deliver the smallest verified increment for audit fixed point constants while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/core/audit-fixed-point-constants.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/audit-fixed-point-constants.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-001 with test/vanilla_parity/core/audit-fixed-point-constants.test.ts proving the new behavior or audit result.
