# [ ] STEP 11-004: Implement Sound Origin Tracking
...
Implement Sound Origin Tracking

## goal

Deliver the smallest verified increment for implement sound origin tracking while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-sound-origin-tracking.ts
- test/vanilla_parity/audio/implement-sound-origin-tracking.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-sound-origin-tracking.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-004 with test/vanilla_parity/audio/implement-sound-origin-tracking.test.ts proving the new behavior or audit result.
