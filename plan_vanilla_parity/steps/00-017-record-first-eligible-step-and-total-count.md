# [ ] STEP 00-017: Record First Eligible Step And Total Count
...
Deliver the smallest verified increment for record first eligible step and total count while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/plan_vanilla_parity/record-first-eligible-step-and-total-count.test.ts
...
- `bun run format`
- `bun test test/plan_vanilla_parity/record-first-eligible-step-and-total-count.test.ts`
- `bun test`
...
- A committed and pushed change set for 00-017 with test/plan_vanilla_parity/record-first-eligible-step-and-total-count.test.ts proving the new behavior or audit result.
