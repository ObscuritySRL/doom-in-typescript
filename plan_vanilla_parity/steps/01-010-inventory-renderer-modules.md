...
Inventory Renderer Modules

## goal

Deliver the smallest verified increment for inventory renderer modules while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-renderer-modules.json
- test/vanilla_parity/current-state/inventory-renderer-modules.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-renderer-modules.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-010 with test/vanilla_parity/current-state/inventory-renderer-modules.test.ts proving the new behavior or audit result.
