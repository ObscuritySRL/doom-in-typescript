# [ ] STEP 02-003: Define Read Only Reference Sandbox Copy Policy
...
Define Read Only Reference Sandbox Copy Policy

## goal

Deliver the smallest verified increment for define read only reference sandbox copy policy while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/define-read-only-reference-sandbox-copy-policy.json
- test/vanilla_parity/oracles/define-read-only-reference-sandbox-copy-policy.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/define-read-only-reference-sandbox-copy-policy.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-003 with test/vanilla_parity/oracles/define-read-only-reference-sandbox-copy-policy.test.ts proving the new behavior or audit result.
