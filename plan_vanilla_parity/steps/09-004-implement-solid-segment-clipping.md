# [ ] STEP 09-004: Implement Solid Segment Clipping
...
Implement Solid Segment Clipping

## goal

Deliver the smallest verified increment for implement solid segment clipping while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/implement-solid-segment-clipping.ts
- test/vanilla_parity/render/implement-solid-segment-clipping.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-solid-segment-clipping.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-004 with test/vanilla_parity/render/implement-solid-segment-clipping.test.ts proving the new behavior or audit result.
