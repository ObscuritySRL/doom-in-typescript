# [ ] STEP 10-028: Gate Intermission And Finale Parity
...
Gate Intermission And Finale Parity

## goal

Deliver the smallest verified increment for gate intermission and finale parity while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/gate-intermission-and-finale-parity.ts
- test/vanilla_parity/ui/gate-intermission-and-finale-parity.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/gate-intermission-and-finale-parity.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-028 with test/vanilla_parity/ui/gate-intermission-and-finale-parity.test.ts proving the new behavior or audit result.
