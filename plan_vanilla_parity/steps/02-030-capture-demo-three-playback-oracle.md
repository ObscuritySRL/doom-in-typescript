# [ ] STEP 02-030: Capture Demo Three Playback Oracle
...
Capture Demo Three Playback Oracle

## goal

Deliver the smallest verified increment for capture demo three playback oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-demo-three-playback-oracle.json
- test/vanilla_parity/oracles/capture-demo-three-playback-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-demo-three-playback-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-030 with test/vanilla_parity/oracles/capture-demo-three-playback-oracle.test.ts proving the new behavior or audit result.
