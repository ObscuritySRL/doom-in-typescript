# [ ] STEP 09-015: Implement Light Level And Colormap Selection
...
Implement Light Level And Colormap Selection

## goal

Deliver the smallest verified increment for implement light level and colormap selection while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/implement-light-level-and-colormap-selection.ts
- test/vanilla_parity/render/implement-light-level-and-colormap-selection.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-light-level-and-colormap-selection.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-015 with test/vanilla_parity/render/implement-light-level-and-colormap-selection.test.ts proving the new behavior or audit result.
