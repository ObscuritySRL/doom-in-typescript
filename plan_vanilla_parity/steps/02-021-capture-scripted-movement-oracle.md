# [ ] STEP 02-021: Capture Scripted Movement Oracle
...
Capture Scripted Movement Oracle

## goal

Deliver the smallest verified increment for capture scripted movement oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-scripted-movement-oracle.json
- test/vanilla_parity/oracles/capture-scripted-movement-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-scripted-movement-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-021 with test/vanilla_parity/oracles/capture-scripted-movement-oracle.test.ts proving the new behavior or audit result.
