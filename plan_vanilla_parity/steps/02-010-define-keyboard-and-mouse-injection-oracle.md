# [ ] STEP 02-010: Define Keyboard And Mouse Injection Oracle
...
Define Keyboard And Mouse Injection Oracle

## goal

Deliver the smallest verified increment for define keyboard and mouse injection oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/define-keyboard-and-mouse-injection-oracle.json
- test/vanilla_parity/oracles/define-keyboard-and-mouse-injection-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/define-keyboard-and-mouse-injection-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-010 with test/vanilla_parity/oracles/define-keyboard-and-mouse-injection-oracle.test.ts proving the new behavior or audit result.
