# [ ] STEP 10-010: Implement Save Game Menu
...
Implement Save Game Menu

## goal

Deliver the smallest verified increment for implement save game menu while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-save-game-menu.ts
- test/vanilla_parity/ui/implement-save-game-menu.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ui/implement-save-game-menu.test.ts`
- `bun test`
...
- A committed and pushed change set for 10-010 with test/vanilla_parity/ui/implement-save-game-menu.test.ts proving the new behavior or audit result.
