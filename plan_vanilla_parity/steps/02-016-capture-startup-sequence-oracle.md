# [ ] STEP 02-016: Capture Startup Sequence Oracle
...
Capture Startup Sequence Oracle

## goal

Deliver the smallest verified increment for capture startup sequence oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-startup-sequence-oracle.json
- test/vanilla_parity/oracles/capture-startup-sequence-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-startup-sequence-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-016 with test/vanilla_parity/oracles/capture-startup-sequence-oracle.test.ts proving the new behavior or audit result.
