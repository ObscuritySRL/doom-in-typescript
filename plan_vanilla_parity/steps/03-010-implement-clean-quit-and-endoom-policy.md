# [ ] STEP 03-010: Implement Clean Quit And Endoom Policy
...
Implement Clean Quit And Endoom Policy

## goal

Deliver the smallest verified increment for implement clean quit and endoom policy while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/bootstrap/implement-clean-quit-and-endoom-policy.ts
- test/vanilla_parity/launch/implement-clean-quit-and-endoom-policy.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-clean-quit-and-endoom-policy.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-010 with test/vanilla_parity/launch/implement-clean-quit-and-endoom-policy.test.ts proving the new behavior or audit result.
