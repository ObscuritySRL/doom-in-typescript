# [ ] STEP 06-012: Implement Slide Move Semantics
...
Implement Slide Move Semantics

## goal

Deliver the smallest verified increment for implement slide move semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/world/implement-slide-move-semantics.ts
- test/vanilla_parity/map/implement-slide-move-semantics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-slide-move-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-012 with test/vanilla_parity/map/implement-slide-move-semantics.test.ts proving the new behavior or audit result.
