# [ ] STEP 04-015: Implement Main Loop Per Frame Ordering
...
Implement Main Loop Per Frame Ordering

## goal

Deliver the smallest verified increment for implement main loop per frame ordering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/core/implement-main-loop-per-frame-ordering.ts
- test/vanilla_parity/core/implement-main-loop-per-frame-ordering.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/implement-main-loop-per-frame-ordering.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-015 with test/vanilla_parity/core/implement-main-loop-per-frame-ordering.test.ts proving the new behavior or audit result.
