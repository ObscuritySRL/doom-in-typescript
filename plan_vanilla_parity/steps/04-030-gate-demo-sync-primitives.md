# [ ] STEP 04-030: Gate Demo Sync Primitives
...
Gate Demo Sync Primitives

## goal

Deliver the smallest verified increment for gate demo sync primitives while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/demo/gate-demo-sync-primitives.ts
- test/vanilla_parity/core/gate-demo-sync-primitives.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/gate-demo-sync-primitives.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-030 with test/vanilla_parity/core/gate-demo-sync-primitives.test.ts proving the new behavior or audit result.
