# [ ] STEP 04-017: Reject Visible Interpolation In Simulation
...
Reject Visible Interpolation In Simulation

## goal

Deliver the smallest verified increment for reject visible interpolation in simulation while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/core/reject-visible-interpolation-in-simulation.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-017 with test/vanilla_parity/core/reject-visible-interpolation-in-simulation.test.ts proving the new behavior or audit result.
