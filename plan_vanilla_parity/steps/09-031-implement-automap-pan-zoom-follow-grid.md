# [ ] STEP 09-031: Implement Automap Pan Zoom Follow Grid
...
Implement Automap Pan Zoom Follow Grid

## goal

Deliver the smallest verified increment for implement automap pan zoom follow grid while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-automap-pan-zoom-follow-grid.ts
- test/vanilla_parity/render/implement-automap-pan-zoom-follow-grid.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-automap-pan-zoom-follow-grid.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-031 with test/vanilla_parity/render/implement-automap-pan-zoom-follow-grid.test.ts proving the new behavior or audit result.
