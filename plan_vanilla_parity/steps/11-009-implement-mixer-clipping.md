# [ ] STEP 11-009: Implement Mixer Clipping
...
Implement Mixer Clipping

## goal

Deliver the smallest verified increment for implement mixer clipping while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/audio/implement-mixer-clipping.ts
- test/vanilla_parity/audio/implement-mixer-clipping.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/audio/implement-mixer-clipping.test.ts`
- `bun test`
...
- A committed and pushed change set for 11-009 with test/vanilla_parity/audio/implement-mixer-clipping.test.ts proving the new behavior or audit result.
