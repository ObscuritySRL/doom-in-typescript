# [ ] STEP 05-025: Build Patch Font Cache
...
Build Patch Font Cache

## goal

Deliver the smallest verified increment for build patch font cache while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/build-patch-font-cache.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/build-patch-font-cache.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-025 with test/vanilla_parity/wad/build-patch-font-cache.test.ts proving the new behavior or audit result.
