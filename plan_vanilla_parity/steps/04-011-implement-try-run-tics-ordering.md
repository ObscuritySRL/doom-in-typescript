# [ ] STEP 04-011: Implement Try Run Tics Ordering
...
Implement Try Run Tics Ordering

## goal

Deliver the smallest verified increment for implement try run tics ordering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/core/implement-try-run-tics-ordering.ts
- test/vanilla_parity/core/implement-try-run-tics-ordering.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/implement-try-run-tics-ordering.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-011 with test/vanilla_parity/core/implement-try-run-tics-ordering.test.ts proving the new behavior or audit result.
