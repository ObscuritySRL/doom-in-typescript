# [ ] STEP 02-019: Capture New Game Episode Skill Path Oracle
...
Capture New Game Episode Skill Path Oracle

## goal

Deliver the smallest verified increment for capture new game episode skill path oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/oracles/capture-new-game-episode-skill-path-oracle.json
- test/vanilla_parity/oracles/capture-new-game-episode-skill-path-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/oracles/capture-new-game-episode-skill-path-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 02-019 with test/vanilla_parity/oracles/capture-new-game-episode-skill-path-oracle.test.ts proving the new behavior or audit result.
