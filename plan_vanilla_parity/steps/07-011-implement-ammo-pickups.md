# [ ] STEP 07-011: Implement Ammo Pickups
...
Implement Ammo Pickups

## goal

Deliver the smallest verified increment for implement ammo pickups while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-ammo-pickups.ts
- test/vanilla_parity/player/implement-ammo-pickups.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-ammo-pickups.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-011 with test/vanilla_parity/player/implement-ammo-pickups.test.ts proving the new behavior or audit result.
