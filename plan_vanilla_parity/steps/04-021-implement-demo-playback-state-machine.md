# [ ] STEP 04-021: Implement Demo Playback State Machine
...
Implement Demo Playback State Machine

## goal

Deliver the smallest verified increment for implement demo playback state machine while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/demo/implement-demo-playback-state-machine.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/implement-demo-playback-state-machine.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-021 with test/vanilla_parity/core/implement-demo-playback-state-machine.test.ts proving the new behavior or audit result.
