# [ ] STEP 03-016: Implement Aspect And Integer Scale Policy
...
Implement Aspect And Integer Scale Policy

## goal

Deliver the smallest verified increment for implement aspect and integer scale policy while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/bootstrap/implement-aspect-and-integer-scale-policy.ts
- test/vanilla_parity/launch/implement-aspect-and-integer-scale-policy.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/launch/implement-aspect-and-integer-scale-policy.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-016 with test/vanilla_parity/launch/implement-aspect-and-integer-scale-policy.test.ts proving the new behavior or audit result.
