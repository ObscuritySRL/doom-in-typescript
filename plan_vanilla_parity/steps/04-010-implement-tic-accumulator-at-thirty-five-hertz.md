# [ ] STEP 04-010: Implement Tic Accumulator At Thirty Five Hertz
...
Implement Tic Accumulator At Thirty Five Hertz

## goal

Deliver the smallest verified increment for implement tic accumulator at thirty five hertz while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/core/implement-tic-accumulator-at-thirty-five-hertz.ts
- test/vanilla_parity/core/implement-tic-accumulator-at-thirty-five-hertz.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/implement-tic-accumulator-at-thirty-five-hertz.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-010 with test/vanilla_parity/core/implement-tic-accumulator-at-thirty-five-hertz.test.ts proving the new behavior or audit result.
