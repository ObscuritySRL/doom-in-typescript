# [ ] STEP 06-013: Implement Teleport Move Semantics
...
Implement Teleport Move Semantics

## goal

Deliver the smallest verified increment for implement teleport move semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/world/implement-teleport-move-semantics.ts
- test/vanilla_parity/map/implement-teleport-move-semantics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-teleport-move-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-013 with test/vanilla_parity/map/implement-teleport-move-semantics.test.ts proving the new behavior or audit result.
