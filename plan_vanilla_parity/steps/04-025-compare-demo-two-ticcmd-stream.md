# [ ] STEP 04-025: Compare Demo Two Ticcmd Stream
...
Compare Demo Two Ticcmd Stream

## goal

Deliver the smallest verified increment for compare demo two ticcmd stream while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/core/compare-demo-two-ticcmd-stream.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-025 with test/vanilla_parity/core/compare-demo-two-ticcmd-stream.test.ts proving the new behavior or audit result.
