# [ ] STEP 09-032: Implement Automap Line And Thing Colors
...
Implement Automap Line And Thing Colors

## goal

Deliver the smallest verified increment for implement automap line and thing colors while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-automap-line-and-thing-colors.ts
- test/vanilla_parity/render/implement-automap-line-and-thing-colors.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-automap-line-and-thing-colors.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-032 with test/vanilla_parity/render/implement-automap-line-and-thing-colors.test.ts proving the new behavior or audit result.
