# [ ] STEP 08-008: Implement Monster Missile Range
...
Implement Monster Missile Range

## goal

Deliver the smallest verified increment for implement monster missile range while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ai/implement-monster-missile-range.ts
- test/vanilla_parity/ai/implement-monster-missile-range.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/ai/implement-monster-missile-range.test.ts`
- `bun test`
...
- A committed and pushed change set for 08-008 with test/vanilla_parity/ai/implement-monster-missile-range.test.ts proving the new behavior or audit result.
