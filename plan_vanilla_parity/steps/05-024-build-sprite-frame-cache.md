# [ ] STEP 05-024: Build Sprite Frame Cache
...
Build Sprite Frame Cache

## goal

Deliver the smallest verified increment for build sprite frame cache while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- test/vanilla_parity/wad/build-sprite-frame-cache.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/wad/build-sprite-frame-cache.test.ts`
- `bun test`
...
- A committed and pushed change set for 05-024 with test/vanilla_parity/wad/build-sprite-frame-cache.test.ts proving the new behavior or audit result.
