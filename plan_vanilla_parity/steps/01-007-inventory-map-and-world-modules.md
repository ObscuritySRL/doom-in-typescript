# [ ] STEP 01-007: Inventory Map And World Modules
...
Inventory Map And World Modules

## goal

Deliver the smallest verified increment for inventory map and world modules while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-map-and-world-modules.json
- test/vanilla_parity/current-state/inventory-map-and-world-modules.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-map-and-world-modules.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-007 with test/vanilla_parity/current-state/inventory-map-and-world-modules.test.ts proving the new behavior or audit result.
