# [ ] STEP 03-027: Preserve Key Down Up Event Ordering
...
Preserve Key Down Up Event Ordering

## goal

Deliver the smallest verified increment for preserve key down up event ordering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/launch/preserve-key-down-up-event-ordering.test.ts`
- `bun test`
...
- A committed and pushed change set for 03-027 with test/vanilla_parity/launch/preserve-key-down-up-event-ordering.test.ts proving the new behavior or audit result.
