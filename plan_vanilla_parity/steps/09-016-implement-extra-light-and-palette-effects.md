# [ ] STEP 09-016: Implement Extra Light And Palette Effects
...
Implement Extra Light And Palette Effects

## goal

Deliver the smallest verified increment for implement extra light and palette effects while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/render/implement-extra-light-and-palette-effects.ts
- test/vanilla_parity/render/implement-extra-light-and-palette-effects.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-extra-light-and-palette-effects.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-016 with test/vanilla_parity/render/implement-extra-light-and-palette-effects.test.ts proving the new behavior or audit result.
