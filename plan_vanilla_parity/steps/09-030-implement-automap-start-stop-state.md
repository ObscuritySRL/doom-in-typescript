# [ ] STEP 09-030: Implement Automap Start Stop State
...
Implement Automap Start Stop State

## goal

Deliver the smallest verified increment for implement automap start stop state while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/ui/implement-automap-start-stop-state.ts
- test/vanilla_parity/render/implement-automap-start-stop-state.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/render/implement-automap-start-stop-state.test.ts`
- `bun test`
...
- A committed and pushed change set for 09-030 with test/vanilla_parity/render/implement-automap-start-stop-state.test.ts proving the new behavior or audit result.
