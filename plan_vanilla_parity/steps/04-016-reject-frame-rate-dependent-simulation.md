# [ ] STEP 04-016: Reject Frame Rate Dependent Simulation
...
Reject Frame Rate Dependent Simulation

## goal

Deliver the smallest verified increment for reject frame rate dependent simulation while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- `bun run format`
- `bun test test/vanilla_parity/core/reject-frame-rate-dependent-simulation.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-016 with test/vanilla_parity/core/reject-frame-rate-dependent-simulation.test.ts proving the new behavior or audit result.
