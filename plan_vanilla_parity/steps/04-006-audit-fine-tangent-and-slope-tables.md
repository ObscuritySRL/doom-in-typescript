# [ ] STEP 04-006: Audit Fine Tangent And Slope Tables
...
Audit Fine Tangent And Slope Tables

## goal

Deliver the smallest verified increment for audit fine tangent and slope tables while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/core/audit-fine-tangent-and-slope-tables.ts
- test/vanilla_parity/core/audit-fine-tangent-and-slope-tables.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/core/audit-fine-tangent-and-slope-tables.test.ts`
- `bun test`
...
- A committed and pushed change set for 04-006 with test/vanilla_parity/core/audit-fine-tangent-and-slope-tables.test.ts proving the new behavior or audit result.
