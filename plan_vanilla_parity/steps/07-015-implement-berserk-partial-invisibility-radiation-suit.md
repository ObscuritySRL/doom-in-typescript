# [ ] STEP 07-015: Implement Berserk Partial Invisibility Radiation Suit
...
Implement Berserk Partial Invisibility Radiation Suit

## goal

Deliver the smallest verified increment for implement berserk partial invisibility radiation suit while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/player/implement-berserk-partial-invisibility-radiation-suit.ts
- test/vanilla_parity/player/implement-berserk-partial-invisibility-radiation-suit.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/player/implement-berserk-partial-invisibility-radiation-suit.test.ts`
- `bun test`
...
- A committed and pushed change set for 07-015 with test/vanilla_parity/player/implement-berserk-partial-invisibility-radiation-suit.test.ts proving the new behavior or audit result.
