# [ ] STEP 01-018: Inventory Tools Reference Capture Surface
...
Inventory Tools Reference Capture Surface

## goal

Deliver the smallest verified increment for inventory tools reference capture surface while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- plan_vanilla_parity/current-state/inventory-tools-reference-capture-surface.json
- test/vanilla_parity/current-state/inventory-tools-reference-capture-surface.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/current-state/inventory-tools-reference-capture-surface.test.ts`
- `bun test`
...
- A committed and pushed change set for 01-018 with test/vanilla_parity/current-state/inventory-tools-reference-capture-surface.test.ts proving the new behavior or audit result.
