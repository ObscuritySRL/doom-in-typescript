# [ ] STEP 06-032: Gate World Movement Against Oracle
...
Gate World Movement Against Oracle

## goal

Deliver the smallest verified increment for gate world movement against oracle while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/world/gate-world-movement-against-oracle.ts
- test/vanilla_parity/map/gate-world-movement-against-oracle.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/gate-world-movement-against-oracle.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-032 with test/vanilla_parity/map/gate-world-movement-against-oracle.test.ts proving the new behavior or audit result.
