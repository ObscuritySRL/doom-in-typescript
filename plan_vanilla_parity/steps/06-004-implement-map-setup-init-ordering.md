# [ ] STEP 06-004: Implement Map Setup Init Ordering
...
Implement Map Setup Init Ordering

## goal

Deliver the smallest verified increment for implement map setup init ordering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-map-setup-init-ordering.ts
- test/vanilla_parity/map/implement-map-setup-init-ordering.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-map-setup-init-ordering.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-004 with test/vanilla_parity/map/implement-map-setup-init-ordering.test.ts proving the new behavior or audit result.
