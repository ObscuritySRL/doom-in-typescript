# [ ] STEP 06-010: Implement Check Position Semantics
...
Implement Check Position Semantics

## goal

Deliver the smallest verified increment for implement check position semantics while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-check-position-semantics.ts
- test/vanilla_parity/map/implement-check-position-semantics.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-check-position-semantics.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-010 with test/vanilla_parity/map/implement-check-position-semantics.test.ts proving the new behavior or audit result.
