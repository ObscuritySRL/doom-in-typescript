# [ ] STEP 06-016: Implement Intercept Ordering
...
Implement Intercept Ordering

## goal

Deliver the smallest verified increment for implement intercept ordering while preserving vanilla DOOM 1.9 behavior and avoiding unverified assumptions.
...
- src/map/implement-intercept-ordering.ts
- test/vanilla_parity/map/implement-intercept-ordering.test.ts
...
- `bun run format`
- `bun test test/vanilla_parity/map/implement-intercept-ordering.test.ts`
- `bun test`
...
- A committed and pushed change set for 06-016 with test/vanilla_parity/map/implement-intercept-ordering.test.ts proving the new behavior or audit result.
