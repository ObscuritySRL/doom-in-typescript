...
const CANONICAL_FINAL_GATE_STEP_CHECKLIST_ROW = `- [x] \`${CANONICAL_FINAL_GATE_STEP_ID}\` \`${CANONICAL_FINAL_GATE_STEP_SLUG}\` | lane: \`${CANONICAL_FINAL_GATE_STEP_LANE}\` | prereqs: \`${CANONICAL_FINAL_GATE_STEP_PREREQUISITES}\` | file: \`${CANONICAL_FINAL_GATE_STEP_FILE_PATH}\``;
