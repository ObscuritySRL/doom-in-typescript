...
describe('plan_final launch: replace-root-doom-entrypoint', () => {
  ...
  test('bun run doom.ts still exits cleanly with code 0 and produces no stderr output (preserves plan_vanilla_parity skeleton invariant)', async () => {
  ...
  test('doom.ts remains the plan_vanilla_parity 03-001 skeleton: contains export {} and no top-level imports', () => {
